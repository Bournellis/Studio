...
- `Projetos/draxos-mobile/` - P2, mobile + PC + browser, Godot 4.6.2 + Supabase (`ARENA_BOSQUE_VISIBLE_V2_PUBLISHED_INTERNAL_ALPHA`; proximo passo e playtest humano do pacote Arena/Bosque Visible V2 publicado antes de abrir tuning amplo ou novas expansoes de modo)
