...
- `Projetos/FpsShooter/` is a P2 implementation tech probe for a PC Windows editor-first first-person shooter in Godot 4.6.2. It is independent from the Draxos product projects, with only a light Draxos visual theme allowed. Current stage: `FPS_SHOOTER_TRACK_01C_ARENA_LAYOUT_COMPLETE`; next step is editor playtest focused on the `Duel Pit V1` map and Track 01 next-focus selection.
...
- `Projetos/FpsShooter/` - P2 tech probe, PC Windows editor-first FPS 3D em Godot 4.6.2 (`FPS_SHOOTER_TRACK_01C_ARENA_LAYOUT_COMPLETE`; proximo passo e playtest humano do mapa `Duel Pit V1` e selecao do proximo foco da Track 01, sem export/Web/mobile/multiplayer)
