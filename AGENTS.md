...
- `Projetos/draxos-mobile/` - P2, mobile + PC + browser, Godot 4.6.2 + Supabase (`BOSQUE_DURABLE_BAU_MOCHILA_V1_PUBLISHED_INTERNAL_ALPHA`; proximo passo e playtest humano do pacote Bosque Durable Bau Mochila v1 publicado, preservando regressao da Arena PVE Menu Flow Simplification v1 e a politica runtime Openworld do Bosque Offline-First Checkpoint v1)
