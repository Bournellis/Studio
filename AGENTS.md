...
- `Projetos/draxos-mobile/` - P2, mobile + PC + browser, Godot 4.6.2 + Supabase (`ARENA_PVE_FIRST_REAL_RUN_PUBLISHED_INTERNAL_ALPHA`; proximo passo e playtest humano do pacote Arena PVE First Real Run + Update Recovery publicado antes de abrir tuning amplo ou novas expansoes de modo)
