...
- `Projetos/FpsShooter/` is a P2 implementation tech probe for a PC Windows editor-first first-person shooter in Godot 4.6.2. It is independent from the Draxos product projects, with only a light Draxos visual theme allowed. Current stage: `FPS_SHOOTER_TRACK_02A_BOT_PRESSURE_JUMP_HOTFIX_COMPLETE`; next step is editor playtest focused on rifle vs Plasma Bolt, pickups, overcharge, bot shot pressure before health routes, simple bot jump and duel readability.
...
- `Projetos/FpsShooter/` - P2 tech probe, PC Windows editor-first FPS 3D em Godot 4.6.2 (`FPS_SHOOTER_TRACK_02A_BOT_PRESSURE_JUMP_HOTFIX_COMPLETE`; proximo passo e playtest humano de rifle vs Plasma Bolt, pickups, overcharge, pressao/salto do bot e leitura do duelo no `Duel Pit V1`, sem export/Web/mobile/multiplayer)
