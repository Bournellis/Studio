...
- `Projetos/draxos-mobile/` - P2, mobile + PC + browser, Godot 4.6.2 + Supabase (`BOSQUE_OVERLAY_INTERACTIVE_CONTROLS_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA`; proximo passo e playtest humano do pacote publicado, validando landmarks/prompts do Bosque, abertura de Arena/Base/Shop/Social/Profile como overlays sobre o Bosque vivo, Social digitavel, Shop confirmavel, Arena retomar/abandonar e retorno via `Fechar`, `Voltar` e Esc sem rebootstrap)
