...
- `Projetos/draxos-mobile/` - P2, mobile + PC + browser, Godot 4.6.2 + Supabase (`ARENA_PVE_MENU_FLOW_SIMPLIFICATION_V1_PUBLISHED_INTERNAL_ALPHA`; proximo passo e playtest humano do pacote Arena PVE Menu Flow Simplification v1 publicado, preservando a politica Openworld do Bosque Offline-First Checkpoint v1)
