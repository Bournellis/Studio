...
- `Projetos/draxos-mobile/` - P2, mobile + PC + browser, Godot 4.6.2 + Supabase (`ARENA_PVE_SEASON1_LOOP_V1_PUBLISHED_INTERNAL_ALPHA`; proximo passo e playtest humano do pacote Arena PVE Season 1 Loop v1 publicado antes de abrir tuning amplo ou novas expansoes de modo)
