...
- `Projetos/draxos-mobile/` - P2, mobile + PC + browser, Godot 4.6.2 + Supabase (`BOSQUE_BOOTSTRAP_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA`; playtest humano inicial do Bosque Bootstrap Authority v1 reportado OK por Fabio em 2026-06-09; foco imediato em corrigir drift documental e consolidar fontes vivas)
