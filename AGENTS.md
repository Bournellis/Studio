...
- `Projetos/FpsShooter/` is a P2 implementation tech probe for a PC Windows editor-first first-person shooter in Godot 4.6.2. It is independent from the Draxos product projects, with only a light Draxos visual theme allowed. Current stage: `FPS_SHOOTER_TRACK_02A_COMBAT_LOOP_EXPANSION_COMPLETE`; next step is editor playtest focused on rifle vs Plasma Bolt, pickups, overcharge and bot contest/dodge readability.
...
- `Projetos/FpsShooter/` - P2 tech probe, PC Windows editor-first FPS 3D em Godot 4.6.2 (`FPS_SHOOTER_TRACK_02A_COMBAT_LOOP_EXPANSION_COMPLETE`; proximo passo e playtest humano de rifle vs Plasma Bolt, pickups, overcharge e leitura do bot no `Duel Pit V1`, sem export/Web/mobile/multiplayer)
