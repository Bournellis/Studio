...
- `Projetos/FpsShooter/` is a P2 implementation tech probe for a PC Windows editor-first first-person shooter in Godot 4.6.2. It is independent from the Draxos product projects, with only a light Draxos visual theme allowed. Current stage: `FPS_SHOOTER_BOOTSTRAP_ACTIVE`; next step is editor playtest and Track 01 - Arena 1x1 V1.
...
- `Projetos/FpsShooter/` - P2 tech probe, PC Windows editor-first FPS 3D em Godot 4.6.2 (`FPS_SHOOTER_BOOTSTRAP_ACTIVE`; proximo passo e editor playtest da arena 1x1 contra bot, sem export/Web/mobile/multiplayer)
