...
- `Projetos/draxos-mobile/` - P2, mobile + PC + browser, Godot 4.6.2 + Supabase (`BOSQUE_OFFLINE_FIRST_CHECKPOINT_V1_PUBLISHED_INTERNAL_ALPHA`; proximo passo e playtest humano do pacote Bosque Offline-First Checkpoint v1 publicado antes de abrir tuning amplo ou novas expansoes de modo)
