...
- `Projetos/draxos-mobile/` is the P2 implementation workspace for DraxosMobile - PVE Arena-first async autobattler, base manager, later PVP, social; Godot 4.6.2 + Supabase; Android + PC + PC browser. Current operational stage: `HARDENING_PLATFORM_V1_PUBLISHED_INTERNAL_ALPHA`; the latest remote Internal Alpha package is Hardening Platform V1 (`internal-alpha/v0-hardening-platform-v1-20260601-19eb80d`, preview `https://68452eed.draxos-mobile-internal-alpha.pages.dev`), preserving Track 21 Arena Loop Unlock/Friction as Autobattler context, Track 20 Season 1 Arena Calibration, Remote Lab Runner, Track 13 validation/release safety and Track 14 `TRACK_14_AGENT_OPS_FOUNDATION_ACTIVE`.
