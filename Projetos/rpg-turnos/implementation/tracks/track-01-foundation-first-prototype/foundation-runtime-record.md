# Foundation Runtime Record

This file preserves the detailed runtime/status record that previously lived in `../../current-status.md`.

Use `../../current-status.md` as the short operational snapshot. Read this file only when detailed implemented-rule history, completed phase notes, or acceptance context is needed.
