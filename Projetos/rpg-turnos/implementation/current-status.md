...
- Latest known validation: `2026-05-06`, `77/77` GUT tests passing through `tools/validate.gd`.
...
- Active track snapshot: `tracks/track-01-foundation-first-prototype/current-status.md`
