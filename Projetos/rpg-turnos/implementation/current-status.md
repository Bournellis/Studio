...
- Latest known validation: `2026-05-12`, `125/125` GUT tests passing through `tools/validate.gd`; 653 asserts.
...
Execute `P08 - Arcano: Pulso Astral Hero Power and Deck Activation` from `tracks/track-02-draxos-lore-progression/linear-execution-plan.md`.
