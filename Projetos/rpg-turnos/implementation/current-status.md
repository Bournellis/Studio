...
- Latest known validation: `2026-05-12`, `78/78` GUT tests passing through `tools/validate.gd`. P04–P06 validation pending local run.
- For documentation-only changes, do not run Godot validation unless explicitly requested.

## Records

- Detailed foundation runtime record: `tracks/track-01-foundation-first-prototype