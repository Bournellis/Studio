...
- Latest known validation: `2026-05-12`, `125/125` GUT tests passing through `tools/validate.gd`; 653 asserts. P10 validation pending local run (13 new tests in test_necromante_cinzas.gd).
...
Execute `P11 - Necromante: Ritual das Sombras Hero Power` from `tracks/track-02-draxos-lore-progression/linear-execution-plan.md`.
