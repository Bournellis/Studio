...
- Latest known validation: `2026-05-12`, `78/78` GUT tests passing through `tools/validate.gd`.
...
Execute `P04 - Invocador Core: Passive and Hero Power` from `tracks/track-02-draxos-lore-progression/linear-execution-plan.md`.
