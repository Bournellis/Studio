...
### 5b. Cartas de Recompensa (11 entradas, 9 designs únicos)
...
### 5c. Carta adicional (presente no catálogo)

| Asset ID | ID no catálogo | Tipo | Prioridade | Descrição da ilustração |
|---|---|---|---|---|
| `card_art_manter_linha` | `manter_linha` | comando | 🟢 | Comandante erguendo escudo, gesto de "segurar posição". |
