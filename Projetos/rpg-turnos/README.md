...
`rpg-turnos` is a provisional Godot project for a turn-based RPG that shares studio lore while remaining mechanically independent from RPG Isometrico.
...
- combat as a separate turn-based mode
...
- `battle/`: turn-based combat contracts and runtime
...
Read `AGENTS.md`, `docs/project-brief.md`, `docs/architecture.md`, and `implementation/current-status.md` before making meaningful changes.
