...
func test_frontend_saved_selection_stays_on_builder_modes() -> void:
	...
	assert_string_contains(second_summary_label.text, "Modo: Arena Bot")
	assert_string_contains(second_summary_label.text, "Raca: Heroico")
	assert_string_contains(second_summary_label.text, "Arma: Martelo Heroico")
	...
	assert_string_contains(second_summary_label.text, "Brado Heroico")
