...
- points manual follow-up to `qa/QA_INDEX.md`; the former smoke checklists are summarized in `implementation/history.md` and recoverable only through the Documentation Lite baseline
