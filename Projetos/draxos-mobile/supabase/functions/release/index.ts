...
const DEFAULT_MANIFEST: ReleaseManifest = {
  ...
  latest_version: "0.0.5-alpha.0",
  latest_version_code: 5,
  minimum_supported_version: "0.0.5-alpha.0",
  ...
  notes: [
    "Arena PVE Menu Flow Simplification v1 publicado na URL principal de Internal Alpha.",
    "APK Android, PC ZIP e Web compartilham o mesmo backend remoto publicado.",
    "Manifesto exige build minima 0.0.5-alpha.0 para evitar instalacao silenciosa de APK anterior.",
    "Menu da Arena PVE reorganiza progresso, desafio recomendado, Preparacao, outras arenas, tentativa ativa e escolha de buff.",
    "Bosque Offline-First Checkpoint v1 segue preservado como politica Openworld ativa.",
    "Arena Preparacao, buff -> Resolver duelo, Bosque checkpoint e pacotes anteriores seguem preservados.",
