...
const FRIENDLY_MESSAGES := {
	...
	"NETWORK_UNAVAILABLE": "Servidor Supabase indisponivel ou bloqueado pelo navegador. Verifique a conexao e tente novamente.",
	"REQUEST_NOT_STARTED": "Requisicao nao iniciou. Verifique URL/chave do Supabase nas Project Settings.",
	...
	"INSUFFICIENT_RESOURCES": "Recursos insuficientes para esta acao. No Refugio, confira Energia, custo e Loja.",
	...
	"INVALID_PRODUCT": "Produto nao encontrado no catalogo atual.",
	"DAILY_REDEEM_ALREADY_CLAIMED": "Este resgate diario ja foi usado hoje neste save.",
	"ALREADY_OWNED": "Este produto ja esta ativo neste save.",
	"REWARD_NOT_FOUND": "Recompensa nao encontrada.",
