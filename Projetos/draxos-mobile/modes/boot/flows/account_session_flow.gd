...
const AccountFormContractScript := preload("res://modes/boot/flows/account_form_contract.gd")
...
func auth_form_values(host: Node, require_username: bool) -> Dictionary:
	return AccountFormContractScript.auth_form_values(host, require_username)

func create_account_form_values(host: Node) -> Dictionary:
	return AccountFormContractScript.create_account_form_values(host)

func effective_alpha_username(username: String) -> String:
	return AccountFormContractScript.effective_alpha_username(username)

func effective_alpha_invite(host: Node, invite_code: String) -> String:
	return AccountFormContractScript.effective_alpha_invite(host, invite_code)

func normalized_alpha_username(username: String) -> String:
	return AccountFormContractScript.normalized_alpha_username(username)

func is_valid_alpha_username(username: String) -> bool:
	return AccountFormContractScript.is_valid_alpha_username(username)
