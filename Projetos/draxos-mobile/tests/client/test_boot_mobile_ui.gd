...
func test_boot_profile_account_panel_shows_save_account_update_and_build_status() -> void:
	...
	assert_true(_label_tree_contains(boot._content_body, "Build: internal_alpha 0.0.9-alpha.0 | online pronto"))
	assert_null(boot._auth_email_input)
...
func test_boot_profile_account_panel_has_clear_empty_state_without_account() -> void:
	...
	assert_true(_label_tree_contains(boot._content_body, "Build: internal_alpha 0.0.9-alpha.0 | aguardando login"))
	assert_null(boot._auth_email_input)
