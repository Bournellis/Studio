...
func test_overlay_layer_state_routes_panel_between_menu_and_arena_layers_without_boot_ui() -> void:
...
func test_overlay_layer_state_uses_topmost_layer_for_hit_testing_without_boot_ui() -> void:
	var refs := _build_overlay_layer_state_fixture()
	var state = refs.get("state")
