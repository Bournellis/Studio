...
func test_project_info_constants_are_set() -> void:
	...
	assert_eq(ProjectInfo.APP_VERSION, "0.0.22-alpha.0")
	assert_eq(ProjectInfo.APP_VERSION_CODE, 22)
...
func test_update_manifest_current_recommended_and_required_status() -> void:
	...
	recommended_manifest["latest_version"] = "0.0.23-alpha.0"
	...
	required_manifest["minimum_supported_version"] = "0.0.23-alpha.0"
