...
- Active Surface: `Post-alpha evolution and Track 04 parallel coordination`
...
| Track 04 | Ativa para evolucao pos-alpha paralela | `T04-P00` concluido por confirmacao do usuario. Execucao paralela oficializada para coordenacao, Hub scaffold, shell/login/update, Base/Loja, Social/Competicao, Batalha/Replay, Progression/Economia e Account/Save Gate. Nao misturar extracao UI com backend/schema; migration `account_profiles` + `game_saves` so depois de decisao documentada. |
...
1. Executar T04-A de coordenacao e manter registros Doing/Handoff atualizados.
2. Iniciar T04-B Hub Scaffold antes das extracoes client paralelas.
3. Rodar T04-G Progression/Economia e T04-H Account/Save Gate em paralelo, sem alterar economia/schema ate decisao documentada.
