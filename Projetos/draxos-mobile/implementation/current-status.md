...
- Active Track Status: `INTEGRATED_PRESENTATION_READY`
...
1. Fazer walkthrough manual mobile/PC/Web do novo loop: Refugio -> Conta -> Base/Social/Competicao/Loja -> Batalha fullscreen -> Summary -> Voltar.
2. Reiniciar/redeployar as Edge Functions locais antes de usar o endpoint padrao `127.0.0.1:54321` para `/battle/history`.
3. Definir a proxima track de assets/servicos/features sobre o novo shell mobile-first.
