...
| Track 08 | Ativa; hardening de fundacao em andamento | Track 08 revisa e endurece a fundacao pos-Track 07: contratos de rota/back/orientacao, session/save/cache/runtime config, touch/scroll/layout, battle mode, service/asset checks e validation harness. Sem gameplay novo, tuning, schema, endpoints publicos, assets finais ou publicacao remota. |
