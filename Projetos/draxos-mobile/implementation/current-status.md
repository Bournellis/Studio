...
| Track 09 | Integrada; loop portrait slim pronto para walkthrough manual | Track 09 separou `entry` operacional de `refuge` jogavel, tornou o app portrait-first e converteu a batalha para portrait fullscreen. Track 09B enxugou Entry, criou popup de conta, auto-navega auth/guest para Refugio e reorganizou Refugio com Caminhos no topo, rotina/estruturas imediatamente visiveis, auto-sync do estado e footer compacto. Sem backend/schema/economia/ranking/recompensas/simulador/publicacao remota. |
