...
1. Republicar APK/PC/Web aprovados da `T03-P17A` nos downloads/Cloudflare/manifest.
2. Executar signoff manual final com Fabio + 1 amigo usando os links atualizados.
