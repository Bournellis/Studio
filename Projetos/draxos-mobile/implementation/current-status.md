...
| Track 08 | Ativa; T08-F pronta para integracao | Track 08 revisa e endurece a fundacao pos-Track 07: contratos de rota/back/orientacao, session/save/cache/runtime config, touch/scroll/layout, battle mode, service/asset checks e validation harness. T08-F adicionou checks leves para matriz de endpoints, feature registry e `AssetIds` fallback. Sem gameplay novo, tuning, schema, endpoints publicos, assets finais ou publicacao remota. |
