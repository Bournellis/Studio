...
- Active Surface: `Refugio game menu scene integrated`
- Active Track: `Track 09 - Portrait Entry, Refugio Scene And Visual Loop Rework`
- Active Track Status: `INTEGRATED_REFUGE_GAME_MENU_READY`
