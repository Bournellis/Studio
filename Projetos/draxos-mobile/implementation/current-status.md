...
| Track 09 | Integrada; loop portrait slim pronto para walkthrough manual | Track 09 separou `entry` operacional de `refuge` jogavel, tornou o app portrait-first, converteu a batalha para portrait fullscreen e reposicionou Base como `base_management` interna. Track 09B enxugou Entry, criou popup de conta, auto-navega auth/guest para Refugio e reorganizou Refugio com Caminhos no topo e footer compacto. Sem backend/schema/economia/ranking/recompensas/simulador/publicacao remota. |
...
1. Fazer walkthrough visual/manual do loop Track 09B no Godot e Android: Entry slim, popup de criar conta, save/lab, Refugio com Caminhos no topo, Base management e battle summary portrait.
