...
1. Publicar `build/internal-alpha/draxos-mobile-cloudflare-pages.zip` no Cloudflare Pages ou configurar `CLOUDFLARE_API_TOKEN` para deploy CLI.
2. Validar `/web` com o HTML novo e executar signoff manual final com Fabio + 1 amigo usando os links atualizados.
3. Depois do signoff, seguir `T03-P18` handoff da Internal Alpha v0.
