...
- Active Surface: `Post-handoff closed playtest and Track 04 planning`
- Active Track: `Track 04 - Post-Handoff Hardening And Hub Modularization`
- Active Track Status: `PLANNED_AFTER_CLOSED_PLAYTEST`
...
- Track 04 Planning: proxima track documentada em `tracks/track-04-post-handoff-hardening-and-hub-modularization/`. A ordem e rodada fechada Fabio + tester, triagem de bugs, UX Android/onboarding, modularizacao incremental do Hub e depois gate de `account_profiles` + `game_saves` se o playtest justificar.
...
- Track 04 e pos-handoff: bugs reais primeiro, UX Android/onboarding depois, modularizacao incremental do Hub sem mudar comportamento e gate futuro para `account_profiles` + `game_saves`.
...
1. `../AGENTS.md`
2. `tracks/track-04-post-handoff-hardening-and-hub-modularization/current-status.md`
3. `tracks/track-04-post-handoff-hardening-and-hub-modularization/scope.md`
4. `tracks/track-04-post-handoff-hardening-and-hub-modularization/implementation-plan.md`
...
1. Rodada fechada Fabio + tester usando `../docs/internal-alpha-v0-handoff.md`.
2. Registrar bugs/feedback pos-handoff e classificar backlog.
3. Iniciar Track 04 somente pelo primeiro item confirmado: bug bloqueante, UX Android/onboarding ou modularizacao sem mudanca de comportamento.
