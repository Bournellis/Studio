...
| T07-D App Screens | Codex | `codex/draxos-mobile/t07-app-screens` | `D:\Estudio-worktrees\draxos-mobile--codex--t07-app-screens` | `COMPLETE_VALIDATED` | Internal responsive Base/Social/Competition/Shop screens |
