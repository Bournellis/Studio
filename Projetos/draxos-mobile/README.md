...
**Status:** `P2_IMPLEMENTACAO - BOSQUE_NODE_COOLDOWN_ACK_V1_PUBLISHED_INTERNAL_ALPHA`
**Baseline:** Bosque Node Cooldown ACK v1 is the latest remote Internal Alpha package: release root `internal-alpha/v0-bosque-node-cooldown-ack-v1-20260608-626b4ad`, preview `https://5cce952e.draxos-mobile-internal-alpha.pages.dev`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/` and direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`. It publishes APK/manifest `0.0.13-alpha.0` / version code `13`, keeps minimum supported version code `13`, preserves operations-v2 persistence, prior feel fixes and resume/exit lifecycle, and fixes node cooldown ACK behavior: local cooldown is anchored to the collection moment, same-session durable remote progress can resync when idle, and terminal server cooldown rejections clear invalid collect ops instead of leaving "aguardando servidor" forever. Bosque Resume Exit Lifecycle v1 remains preserved as the previous resume/exit package. Bosque Feel & Spawn Authority v1 remains preserved as the previous feel/spawn package. Bosque Persistence Rebase v1 remains preserved as the previous persistence/operations package. Bosque Session Lifecycle & Durable Structures Hotfix v1 remains preserved as the previous session lifecycle package. Bosque World Hub Domain Separation v1 remains preserved as the previous local/account domain package. Bosque Fogueira Potion Crafting v1 remains preserved as the previous station-craft package. Bosque Durable Bau Mochila v1 remains preserved as the previous durable Openworld progress package. Arena PVE Menu Flow Simplification v1 remains preserved as the previous Arena menu package. Track 13 release safety and Track 14 agent ops remain preserved baselines.
## Current Focus
...
- Current verified preview: `https://5cce952e.draxos-mobile-internal-alpha.pages.dev`
- Current release root: `internal-alpha/v0-bosque-node-cooldown-ack-v1-20260608-626b4ad`
...
- Current APK SHA256: `c2167096aa2ab0df5c2d4d9e4740e1dd8fa7676bc54ae7af9254d87a2d6e540f`
- Current PC ZIP SHA256: `5bf641d228425f9d47e91b3e7fab20774b21864ac3cd0227a72bb188afb72477`
- Current Web Index SHA256: `4b015300456471c94859406612b22326076ced4f787e458cc6d8f3776461bb73`
