...
4. Playtest the published Arena PVE Season 1 Loop v1 package first, focusing tutorial -> first real 3-duel Arena, grouped Season 1 selection, reward preview, resume/abandon/old-attempt recovery, pending buff recovery after reopen/update, Preparacao in the active-duel menu, selected buff -> `Resolver duelo`, and regressions in the main menu/Bosque/Arena paths.
...
- Current verified preview: `https://d7333659.draxos-mobile-internal-alpha.pages.dev`
- Current release root: `internal-alpha/v0-arena-pve-season1-loop-v1-20260605-c8baf32`
- Current APK: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-arena-pve-season1-loop-v1-20260605-c8baf32/downloads/draxos-mobile-alpha.apk`
- Current PC ZIP: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-arena-pve-season1-loop-v1-20260605-c8baf32/downloads/draxos-mobile-alpha.zip`
