...
4. Playtest the published Arena/Bosque Visible V2 package first, focusing update-required behavior from old APK/version code `1`, Preparacao before Arena start, inside active attempts, on blocked active/stuck attempts and on pending buff choice, tutorial -> first real 3-duel Arena, grouped Season 1 selection, reward preview, resume/abandon/old-attempt recovery, pending buff recovery after reopen/update, selected buff -> `Resolver duelo`, and Bosque deposit/craft/persistencia paths.
...
- Current verified preview: `https://7b9c8f38.draxos-mobile-internal-alpha.pages.dev`
- Current release root: `internal-alpha/v0-arena-bosque-visible-v2-20260605-01d80d5`
- Current APK: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-arena-bosque-visible-v2-20260605-01d80d5/downloads/draxos-mobile-alpha.apk`
- Current PC ZIP: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-arena-bosque-visible-v2-20260605-01d80d5/downloads/draxos-mobile-alpha.zip`
