...
**Baseline:** Bosque Overlay Layer And Readiness Authority v1 is the latest remote Internal Alpha package: release root `internal-alpha/v0-bosque-overlay-layer-readiness-authority-v1-20260610-181861c`, preview `https://a9e3b2f9.draxos-mobile-internal-alpha.pages.dev`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/` and direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`. It publishes APK/manifest `0.0.23-alpha.0` / version code `23`, keeps minimum supported version code `13`, redeploys `release`, adds explicit overlay layers, renders Arena active/replay fullscreen above the menu panel, moves confirmations to a global topmost modal, and exposes route readiness so server-backed menus show synchronization instead of silently ignoring early clicks. Next step: focused human playtest of this published package. Bosque Arena Abandon Recovery Authority v1 remains preserved as the previous Arena abandon recovery package; Bosque Overlay Interactive Controls Authority v1 remains preserved as the previous Social/Shop/Arena-controls package; Bosque Overlay Menu Action Authority v1 remains preserved as the previous internal-menu-button package; Bosque Overlay Interaction Authority v1 remains preserved as the previous close/back package; Bosque Overlay Navigation Hotfix v1 remains preserved as the previous interaction hotfix package; Bosque Persistent Overlay Shell v1 remains preserved as the previous overlay package; Bosque Diegetic Launcher Foundation v1 remains preserved as the previous launcher package; Bosque Bootstrap Authority v1 remains preserved as the previous bootstrap package; Arena PVE Bonus Visual v1 remains preserved as the previous Arena package; Bosque Node Cooldown ACK v1 remains preserved as the previous Bosque persistence/spawn package. Track 13 release safety and Track 14 agent ops remain preserved baselines.
## Current Focus
...
4. Treat focused human playtest of the published Bosque Overlay Layer And Readiness Authority v1 Web/APK package as the next operational step, especially Arena abandon -> Bosque -> new Arena without panel clipping, global confirmation modal topmost, Social/Shop readiness feedback and regression of craft/check update/sync. Do not open tuning, PVP, economy, content, weapons, spells, potions, final visuals, remote mutation or new package scope without a separate explicit decision.
...
- Current verified preview: `https://a9e3b2f9.draxos-mobile-internal-alpha.pages.dev`
- Current release root: `internal-alpha/v0-bosque-overlay-layer-readiness-authority-v1-20260610-181861c`
...
- Current APK SHA256: `986bff2ac180de883f5dfa97078e0a3ff31e2c0d4de139b8863c18e1d37507ab`
- Current PC ZIP SHA256: `4659da781b027dcb1c9f1b5d6ec32e56630eac14160413a35cb75a90c2e8c0dc`
- Current Web Index SHA256: `0f6e3e655367df73f9a6d3ba2ee5a4e205b487bbda03a108ec9fc6db3a7bd73b`
...
- Previous Arena abandon recovery package: Bosque Arena Abandon Recovery Authority v1 remains the previous Arena abandon recovery package.
- Previous Arena abandon recovery verified preview: `https://b149da8f.draxos-mobile-internal-alpha.pages.dev`
- Previous Arena abandon recovery release root: `internal-alpha/v0-bosque-arena-abandon-recovery-authority-v1-20260610-a252241`
- Previous interactive-controls package: Bosque Overlay Interactive Controls Authority v1 remains the previous Social/Shop/Arena-controls package.
- Previous interactive-controls verified preview: `https://9461e4be.draxos-mobile-internal-alpha.pages.dev`
- Previous interactive-controls release root: `internal-alpha/v0-bosque-overlay-interactive-controls-authority-v1-20260609-d3be1fb`
- Previous internal-menu-button package: Bosque Overlay Menu Action Authority v1 remains the previous internal-menu-button package.
- Previous internal-menu-button verified preview: `https://5f04e6ae.draxos-mobile-internal-alpha.pages.dev`
- Previous internal-menu-button release root: `internal-alpha/v0-bosque-overlay-menu-action-authority-v1-20260609-aa9402d`
...
- Previous Bosque package: Bosque Node Cooldown ACK v1 remains the previous Bosque package.
- Previous Bosque verified preview: `https://5cce952e.draxos-mobile-internal-alpha.pages.dev`
- Previous Bosque release root: `internal-alpha/v0-bosque-node-cooldown-ack-v1-20260608-626b4ad`
- Previous resume/exit package: Bosque Resume Exit Lifecycle v1 remains the previous resume/exit package.
- Previous resume/exit verified preview: `https://39128c59.draxos-mobile-internal-alpha.pages.dev`
- Previous resume/exit release root: `internal-alpha/v0-bosque-resume-exit-lifecycle-v1-20260608-9a0f7c0`
- Previous feel/spawn package: Bosque Feel & Spawn Authority v1 remains the previous feel/spawn package.
- Previous feel/spawn verified preview: `https://16ac3cb7.draxos-mobile-internal-alpha.pages.dev`
