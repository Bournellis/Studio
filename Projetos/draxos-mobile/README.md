...
4. Playtest the published Arena PVE Menu Flow Simplification v1 package first, focusing the Arena selection order, single recommended CTA, Preparacao before start, active attempt recovery, `Resolver duelo`/`Escolher buff` ordering and behavior controls between fights. Preserve Bosque Offline-First Checkpoint v1 regression coverage: stable Bosque entry, rapid collection without restart, immediate deposit/craft while checkpoint is saving and final reward only after accepted checkpoint.
...
- Current verified preview: `https://fdf44707.draxos-mobile-internal-alpha.pages.dev`
- Current release root: `internal-alpha/v0-arena-pve-menu-flow-simplification-v1-20260606-5d03a68`
- Current APK: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-arena-pve-menu-flow-simplification-v1-20260606-5d03a68/downloads/draxos-mobile-alpha.apk`
- Current PC ZIP: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-arena-pve-menu-flow-simplification-v1-20260606-5d03a68/downloads/draxos-mobile-alpha.zip`
- Previous Openworld policy package: Bosque Offline-First Checkpoint v1 remains the current Openworld/Bosque policy package.
