...
**Baseline:** Bosque Resume Exit Lifecycle v1 is the latest remote Internal Alpha package: release root `internal-alpha/v0-bosque-resume-exit-lifecycle-v1-20260608-9a0f7c0`, preview `https://39128c59.draxos-mobile-internal-alpha.pages.dev`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/` and direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`. It publishes APK/manifest `0.0.12-alpha.0` / version code `12`, keeps minimum supported version code `12`, preserves operations-v2 persistence and the prior feel fixes, and fixes `Voltar -> reabrir Bosque -> sair`: preserved live sessions are resumed instead of replaced by a new out-of-save Bosque, active-session start conflicts return the existing session, and failed checkpoint/exit no longer traps the player inside the mode. Bosque Feel & Spawn Authority v1 remains preserved as the previous feel/spawn package. Bosque Persistence Rebase v1 remains preserved as the previous persistence/operations package. Bosque Session Lifecycle & Durable Structures Hotfix v1 remains preserved as the previous session lifecycle package. Bosque World Hub Domain Separation v1 remains preserved as the previous local/account domain package. Bosque Fogueira Potion Crafting v1 remains preserved as the previous station-craft package. Bosque Durable Bau Mochila v1 remains preserved as the previous durable Openworld progress package. Arena PVE Menu Flow Simplification v1 remains preserved as the previous Arena menu package. Track 13 release safety and Track 14 agent ops remain preserved baselines.
## Current Focus
...
- Current verified preview: `https://39128c59.draxos-mobile-internal-alpha.pages.dev`
- Current release root: `internal-alpha/v0-bosque-resume-exit-lifecycle-v1-20260608-9a0f7c0`
...
- Current APK SHA256: `546131c81c7bab0d43f04f4223b44ef7e5df7b25fb9877b743f4ff4c3622d0e3`
- Current PC ZIP SHA256: `8bbd031d3e0b43c5a9b38c04509b1b7db0f0e8e372f427ba31634138c443c554`
- Current Web Index SHA256: `fca57c810699ac80bd05a633905618ed569a3dbeb22850ce63af8b9b96390893`
