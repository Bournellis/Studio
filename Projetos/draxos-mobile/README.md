...
4. Playtest the published Bosque Offline-First Checkpoint v1 package first, focusing stable Bosque entry without visible world transform, 10+ rapid collections without action restart, immediate deposit/craft while checkpoint is saving, `Voltar` preserving local visit, reopen before/after checkpoint preserving pocket/chest/nodes, final reward only after accepted checkpoint, plus Arena Preparacao and selected buff -> `Resolver duelo` regression coverage.
...
- Current verified preview: `https://ad0b4a77.draxos-mobile-internal-alpha.pages.dev`
- Current release root: `internal-alpha/v0-bosque-offline-first-checkpoint-v1-20260606-254ac0a`
- Current APK: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-bosque-offline-first-checkpoint-v1-20260606-254ac0a/downloads/draxos-mobile-alpha.apk`
- Current PC ZIP: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-bosque-offline-first-checkpoint-v1-20260606-254ac0a/downloads/draxos-mobile-alpha.zip`
