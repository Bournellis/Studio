...
| Objetivo | Status |
|---|---|
| Build fechada Internal Alpha v0 com conta email/senha, dois saves, backend remoto, updates e features principais funcionais | T03-P17 backend/downloads/Portal/Web e QA automatizado remoto verdes; falta signoff manual Fabio + tester |
