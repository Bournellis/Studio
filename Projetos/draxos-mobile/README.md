...
**Status:** `P2_IMPLEMENTACAO - BOSQUE_PERSISTENCE_REBASE_V1_PUBLISHED_INTERNAL_ALPHA`
**Baseline:** Bosque Persistence Rebase v1 is the latest remote Internal Alpha package: release root `internal-alpha/v0-bosque-persistence-rebase-v1-20260608-bc23f74`, preview `https://0c0a8dcf.draxos-mobile-internal-alpha.pages.dev`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/` and direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`. It publishes APK/manifest `0.0.10-alpha.0` / version code `10`, forces minimum supported version code `10`, makes Bosque durable progress server-authoritative through ACK-backed checkpoint operations, persists `openworld_forest_progress_v2`, applies node cooldowns through `node_state.next_spawn_at`, blocks/labels pending durable operations honestly, and keeps Fogueira station unlock behind server-confirmed `structures.fogueira_estavel_1`. Bosque Session Lifecycle & Durable Structures Hotfix v1 remains preserved as the previous session lifecycle package. Bosque World Hub Domain Separation v1 remains preserved as the previous local/account domain package. Bosque Fogueira Potion Crafting v1 remains preserved as the previous station-craft package. Bosque Durable Bau Mochila v1 remains preserved as the previous durable Openworld progress package. Arena PVE Menu Flow Simplification v1 remains preserved as the previous Arena menu package. Track 13 release safety and Track 14 agent ops remain preserved baselines.
## Current Focus
...
- Current verified preview: `https://0c0a8dcf.draxos-mobile-internal-alpha.pages.dev`
- Current release root: `internal-alpha/v0-bosque-persistence-rebase-v1-20260608-bc23f74`
- Current APK: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-bosque-persistence-rebase-v1-20260608-bc23f74/downloads/draxos-mobile-alpha.apk`
- Current PC ZIP: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-bosque-persistence-rebase-v1-20260608-bc23f74/downloads/draxos-mobile-alpha.zip`
- Current APK SHA256: `1679e8db843331707d22bb083c29eeb5182cb92cf141b4d6f46fd2ddeee3c858`
- Current PC ZIP SHA256: `49d080f57a31f2ceead45f678a60c57e27f89a9d8964114a3499bc42ca8e63e3`
- Current Web Index SHA256: `a79ce8e74a64468611806cdaa41e73cfbbf6671180d33a9b7d422503ff91c2d9`
