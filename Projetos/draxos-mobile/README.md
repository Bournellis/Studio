...
**Baseline:** Arena/Bosque Regression Hotfix is the latest remote Internal Alpha package: release root `internal-alpha/v0-arena-bosque-regression-hotfix-20260605-a16ca4f`, preview `https://bbd81ec5.draxos-mobile-internal-alpha.pages.dev`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/` and direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`. It preserves Arena PVE Season 1 Loop v1, then restores Preparacao before Arena start, during active attempts and on pending buff choice, plus Bosque deposit/craft visible feedback and pending-event flush before leaving integrated sessions. Arena PVE Season 1 Loop v1 remains preserved as the previous Season 1 package. Arena Duel Flow Hotfix remains preserved as the previous hotfix package. Arena PVE First Real Run + Update Recovery remains preserved as the previous Arena package. Bosque v3 UX/Feel remains preserved as the previous content/polish package. Technical Hardening remains the previous technical package. Openworld Main Menu Sync remains the previous Openworld content package. Bosque Mecanico Basico v2 remains the previous Bosque guidance package. Foundation Hardening V2 remains the previous multi-mode expansion enforcement baseline. Track 13 release safety and Track 14 agent ops remain preserved baselines. Track 16 is technical behavior/potion/crafting context. Track 18 Arena PVE Initial, Track 20 Season 1 Arena Calibration, Track 21 Arena Loop Unlock/Friction, Track 23 update recovery and Remote Lab Runner remain preserved Arena/Autobattler/Lab context.
...
4. Playtest the published Arena/Bosque Regression Hotfix package first, focusing Preparacao before Arena start, inside active attempts and on pending buff choice, tutorial -> first real 3-duel Arena, grouped Season 1 selection, reward preview, resume/abandon/old-attempt recovery, pending buff recovery after reopen/update, selected buff -> `Resolver duelo`, and Bosque deposit/craft/persistencia paths.
...
- Current release root: `internal-alpha/v0-arena-bosque-regression-hotfix-20260605-a16ca4f`
- Current APK: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-arena-bosque-regression-hotfix-20260605-a16ca4f/downloads/draxos-mobile-alpha.apk`
- Current PC ZIP: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-arena-bosque-regression-hotfix-20260605-a16ca4f/downloads/draxos-mobile-alpha.zip`
...
- Previous hotfix package: Arena Duel Flow Hotfix, release root `internal-alpha/v0-arena-duel-flow-hotfix-20260605-7ce5174`, preview `https://0536635b.draxos-mobile-internal-alpha.pages.dev`.
