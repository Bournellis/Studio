...
- Active operational stage: `Bosque Session Lifecycle & Durable Structures Hotfix v1`
- Active stage status: `BOSQUE_SESSION_LIFECYCLE_STRUCTURES_HOTFIX_V1_PUBLISHED_INTERNAL_ALPHA`
- Latest remote Internal Alpha package: `Bosque Session Lifecycle & Durable Structures Hotfix v1`,
  release root `internal-alpha/v0-bosque-session-lifecycle-structures-hotfix-v1-20260607-c953b51`,
  official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`,
  direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`,
  deployment evidence `https://8ecac093.draxos-mobile-internal-alpha.pages.dev`.
- Build version: `0.0.9-alpha.0` / version code `9`.
...
- Immediate product gate: Bosque Session Lifecycle & Durable Structures Hotfix v1 is the latest remote Internal Alpha publication for human playtest. It keeps active Bosque gameplay client-owned/offline-first, prevents expired visits from being resumed, restores full spawn when a new visit starts after expiration, persists durable `structures`, canonicalizes `fogueira_estavel_1` as durable `upgrades` and `structures`, and preserves Fogueira station craft as the server-authoritative bridge to global potions. Bosque World Hub Domain Separation v1 remains the previous local/account domain package; Bosque Fogueira Potion Crafting v1 remains the previous station-craft package; Bosque Durable Bau Mochila v1 remains the previous durable Openworld progress package; Arena PVE Menu Flow Simplification v1 remains the previous Arena menu package; Bosque Offline-First Checkpoint v1 remains the previous Openworld policy package; Bosque Sync Responsiveness v1 remains the previous Bosque sync package for `collect_batch` compatibility. Arena/Bosque Visible V2, Arena/Bosque Regression Hotfix, Arena PVE Season 1 Loop v1, Arena Duel Flow Hotfix and Track 21 remain preserved Arena/Autobattler context.
...
Bosque Session Lifecycle & Durable Structures Hotfix v1 is the latest remote Internal Alpha publication. New DraxosMobile agents should branch from updated `main`, use a dedicated worktree and follow `docs/multi-agent-workflow.md`. Latest remote preview evidence: `https://8ecac093.draxos-mobile-internal-alpha.pages.dev`; release root: `internal-alpha/v0-bosque-session-lifecycle-structures-hotfix-v1-20260607-c953b51`; official URL remains `https://draxos-mobile-internal-alpha.pages.dev/`; direct Web URL remains `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`. APK: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-bosque-session-lifecycle-structures-hotfix-v1-20260607-c953b51/downloads/draxos-mobile-alpha.apk`. PC ZIP: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-bosque-session-lifecycle-structures-hotfix-v1-20260607-c953b51/downloads/draxos-mobile-alpha.zip`.

The current package corrects Bosque visit lifecycle and durable structure persistence: expired visits must not be resumed as active sessions, a new visit after expiration starts with `collected_nodes = {}` and full spawn, durable `Bau`, `Mochila`, `upgrades` and `structures` persist per save, and `fogueira_estavel_1` must persist in both durable `upgrades` and `structures`. Station craft stays server-authoritative and uses `Bau do Bosque` plus `Conta/Ossario`, while active Bosque traversal/coleta/deposito/construcoes remain client-owned/offline-first. Bosque World Hub Domain Separation v1 remains the previous local/account resource package. Bosque Fogueira Potion Crafting v1 remains the previous station-craft package. Bosque Durable Bau Mochila v1, Arena PVE Menu Flow Simplification v1, Bosque Offline-First Checkpoint v1, Bosque Sync Responsiveness v1, Arena/Bosque Visible V2 and Arena/Bosque Regression Hotfix remain preserved earlier baselines. Do not change gameplay tuning, Supabase APIs, economy, content, weapons, spells, potions, crafting, advanced behavior, final visuals or authoritative flows without an explicit package decision.
