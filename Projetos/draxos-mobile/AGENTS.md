...
- Active operational stage: `Bosque Diegetic Launcher Foundation v1`
- Active stage status: `BOSQUE_DIEGETIC_LAUNCHER_FOUNDATION_V1_PUBLISHED_INTERNAL_ALPHA`
- Latest remote Internal Alpha package: `Bosque Diegetic Launcher Foundation v1`,
...
- Build version: `0.0.16-alpha.0` / version code `16`; minimum supported version code `13`.
