...
- Active operational stage: `Bosque Node Cooldown ACK v1`
- Active stage status: `BOSQUE_NODE_COOLDOWN_ACK_V1_PUBLISHED_INTERNAL_ALPHA`
- Latest remote Internal Alpha package: `Bosque Node Cooldown ACK v1`,
  release root `internal-alpha/v0-bosque-node-cooldown-ack-v1-20260608-626b4ad`,
  official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`,
  direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`,
  deployment evidence `https://5cce952e.draxos-mobile-internal-alpha.pages.dev`.
- Build version: `0.0.13-alpha.0` / version code `13`.
