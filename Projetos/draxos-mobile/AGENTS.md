...
- Active operational stage: `Bosque Overlay Layer And Readiness Authority v1`
- Active stage status: `BOSQUE_OVERLAY_LAYER_READINESS_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA`
- Latest remote Internal Alpha package: `Bosque Overlay Layer And Readiness Authority v1`,
...
- Build version: `0.0.23-alpha.0` / version code `23`; minimum supported version code `13`.
