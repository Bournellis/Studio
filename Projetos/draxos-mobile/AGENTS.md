...
- Active operational stage: `Bosque World Hub Domain Separation v1`
- Active stage status: `BOSQUE_WORLD_HUB_DOMAIN_SEPARATION_V1_PUBLISHED_INTERNAL_ALPHA`
- Latest remote Internal Alpha package: `Bosque World Hub Domain Separation v1`,
  release root `internal-alpha/v0-bosque-world-hub-domain-separation-v1-20260606-81ecf05`,
  official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`,
  direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`,
  deployment evidence `https://d1872010.draxos-mobile-internal-alpha.pages.dev`.
- Build version: `0.0.8-alpha.0` / version code `8`.
...
Bosque World Hub Domain Separation v1 is the latest remote Internal Alpha publication on `main`. New DraxosMobile agents should branch from updated `main`, use a dedicated worktree and follow `docs/multi-agent-workflow.md`. Latest remote preview evidence: `https://d1872010.draxos-mobile-internal-alpha.pages.dev`; release root: `internal-alpha/v0-bosque-world-hub-domain-separation-v1-20260606-81ecf05`; official URL remains `https://draxos-mobile-internal-alpha.pages.dev/`; direct Web URL remains `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`. APK: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-bosque-world-hub-domain-separation-v1-20260606-81ecf05/downloads/draxos-mobile-alpha.apk`. PC ZIP: `https://armxgipvnbbshzqawklw.supabase.co/storage/v1/object/public/draxos-internal-alpha/internal-alpha/v0-bosque-world-hub-domain-separation-v1-20260606-81ecf05/downloads/draxos-mobile-alpha.zip`.

The current package corrects local/account resource separation and Fogueira durability: Bosque local materials are `resto_ritual` and `po_cinzento`; account resources remain `ossos` and `po_osso`; `fogueira_estavel_1` must persist in both durable `upgrades` and `structures`. Station craft stays server-authoritative and uses `Bau do Bosque` plus `Conta/Ossario`, while active Bosque traversal/coleta/deposito/construcoes remain client-owned/offline-first. Bosque Fogueira Potion Crafting v1 remains the previous station-craft package: `internal-alpha/v0-bosque-fogueira-potion-crafting-v1-20260606-cad6d2c`, preview evidence `https://08d00f24.draxos-mobile-internal-alpha.pages.dev`. Bosque Durable Bau Mochila v1, Arena PVE Menu Flow Simplification v1, Bosque Offline-First Checkpoint v1, Bosque Sync Responsiveness v1, Arena/Bosque Visible V2 and Arena/Bosque Regression Hotfix remain preserved earlier baselines. Do not change gameplay tuning, Supabase APIs, economy, content, weapons, spells, potions, crafting, advanced behavior, final visuals or authoritative flows without an explicit package decision.
