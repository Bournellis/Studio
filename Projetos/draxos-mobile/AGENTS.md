...
- Active operational stage: `Bosque Offline-First Checkpoint v1`
- Active stage status: `PUBLISHED_INTERNAL_ALPHA`
- Latest remote Internal Alpha package: `Bosque Offline-First Checkpoint v1`,
  release root `internal-alpha/v0-bosque-offline-first-checkpoint-v1-20260606-254ac0a`,
  official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`,
  direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`,
  deployment evidence `https://ad0b4a77.draxos-mobile-internal-alpha.pages.dev`.
