...
| DMOB-D030 | Balanceamento | CALIBRAVEL_ALPHA | Quais valores finais de dano, cooldown, mana, DoT, Familiar, Doutrina e anti-stall? | Rodadas de tuning em 2026-05-21 permanecem como historico pre-rework. A rodada 2026-05-25 atualizou a taxonomia de personagem sem calibrar numeros; Battle Lab pos-rework gerou `3132` batalhas, status `CRITICAL`, anti-stall `26.98%` e dominancia em poder proximo maxima `84.79%`. Proxima hipotese deve focar anti-stall, dominancia por Instrumento/Familiar/status e pesos de poder. | `game-design-document.md` | CALIBRAR | - |
