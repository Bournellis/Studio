...
| DMOB-D064 | Tamanho da arena | PRIMEIRO_SLICE | Resolvido: cap inicial de 5 duelos; tutorial de 1 duelo; primeiras arenas de 3 duelos; arenas de 4 e 5 duelos contratadas para unlock por dificuldade/progresso. | Sem cap, UX de lista, recompensa de conclusao, pacing e Progression Lab ficariam sem alvo. | `pve-arena-v1.md` | RESOLVIDO | 2026-05-31 |
