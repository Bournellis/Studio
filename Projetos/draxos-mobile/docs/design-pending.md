...
| DMOB-D050 | Loja | PLAYTEST_ALPHA | Quais redeems alpha fixos testam free, premium leve e premium alto sem parecer pagamento real? | Parcial: pacotes `pequeno`, `medio`, `grande` e `premium`, 1 vez por dia por save, loja ativa em ambos os saves. Faltam quantidades/custos, moeda usada e horario de reset. | `docs/internal-alpha-v0-design-lock.md` | CALIBRAR | - |
...
| DMOB-D052 | Social | PLAYTEST_ALPHA | Quais limites sociais entram no alpha fechado: amigos, guilda, chat, rate limit, bloqueio e moderacao minima? | Resolvido: social e da conta inteira, inclui amigos, direct, guilda e chat de guilda; moderacao v0 fica em rate limit. Follow-up menor: confirmar se amigo adiciona por username, email ou ambos. | `docs/internal-alpha-v0-design-lock.md` | RESOLVIDO | 2026-05-26 |
