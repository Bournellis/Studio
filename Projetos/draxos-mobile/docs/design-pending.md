...
| DMOB-D062 | Minigames | RPGSUAVE_ALPHA | Resolvido: `rpgsuave` v0 fica em Labs Dev, slice `forest`, progresso local por default, plataforma server-authoritative `minigames` e Reward Bridge pequeno/diario bloqueado para `progression_lab`. | Sem esta decisao, o minigame poderia misturar sensacao de jogo com saldo real sem contrato. | `docs/minigames/rpgsuave.md` | RESOLVIDO | 2026-05-31 |
