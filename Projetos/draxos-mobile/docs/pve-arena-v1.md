...
- Estado operacional atual: `BOSQUE_OVERLAY_INTERACTION_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA`; pacote remoto atual `Bosque Overlay Interaction Authority v1`, release root `internal-alpha/v0-bosque-overlay-interaction-authority-v1-20260609-a8aa9a0`, evidencia `https://1ee9e2a0.draxos-mobile-internal-alpha.pages.dev`, versao `0.0.19-alpha.0`, version code `19`, minimum supported version code `13`.
