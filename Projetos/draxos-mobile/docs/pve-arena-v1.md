...
- Estado operacional atual: `BOSQUE_PERSISTENT_OVERLAY_SHELL_V1_PUBLISHED_INTERNAL_ALPHA`; pacote remoto atual `Bosque Persistent Overlay Shell v1`, release root `internal-alpha/v0-bosque-persistent-overlay-shell-v1-20260609-d05081c`, evidencia `https://a53c1d27.draxos-mobile-internal-alpha.pages.dev`, versao `0.0.17-alpha.0`, version code `17`, minimum supported version code `13`.
