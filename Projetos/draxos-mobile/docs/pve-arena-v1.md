...
- Estado operacional atual: `BOSQUE_OVERLAY_MENU_ACTION_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA`; pacote remoto atual `Bosque Overlay Menu Action Authority v1`, release root `internal-alpha/v0-bosque-overlay-menu-action-authority-v1-20260609-aa9402d`, evidencia `https://5f04e6ae.draxos-mobile-internal-alpha.pages.dev`, versao `0.0.20-alpha.0`, version code `20`, minimum supported version code `13`.
