...
- Estado operacional atual: `BOSQUE_OVERLAY_NAVIGATION_HOTFIX_V1_PUBLISHED_INTERNAL_ALPHA`; pacote remoto atual `Bosque Overlay Navigation Hotfix v1`, release root `internal-alpha/v0-bosque-overlay-navigation-hotfix-v1-20260609-9b93e5d`, evidencia `https://92cc0579.draxos-mobile-internal-alpha.pages.dev`, versao `0.0.18-alpha.0`, version code `18`, minimum supported version code `13`.
