...
direcao: Bosque Overlay Interactive Controls Authority v1 e o pacote publicado atual; Arena PVE segue
...
1. Playtestar o pacote publicado `Bosque Overlay Interactive Controls Authority v1` em Web/APK, focando prompts/landmarks do Bosque, abertura de Arena/Base/Shop/Social/Profile, Social digitavel, Shop confirmavel, Arena retomar/abandonar e retorno via `Fechar`, `Voltar` e Esc.
...
1. Rodar playtest humano do pacote publicado `Bosque Overlay Interactive Controls Authority v1`, incluindo Social typing/actions, Shop cancel/confirm e Arena retomar/abandonar.
