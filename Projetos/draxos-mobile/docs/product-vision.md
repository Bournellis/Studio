...
Etapa operacional atual: `BOSQUE_PERSISTENT_OVERLAY_SHELL_V1_PUBLISHED_INTERNAL_ALPHA`.

Pacote remoto Internal Alpha atual: `Bosque Persistent Overlay Shell v1`, release root `internal-alpha/v0-bosque-persistent-overlay-shell-v1-20260609-d05081c`, evidencia `https://a53c1d27.draxos-mobile-internal-alpha.pages.dev`, portal oficial `https://draxos-mobile-internal-alpha.pages.dev/`, Web direto `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, versao `0.0.17-alpha.0`, version code `17`, minimum supported version code `13`.

Playtest humano inicial do pacote anterior, Bosque Bootstrap Authority v1, foi reportado OK por Fabio em 2026-06-09: tudo testado ate aquele momento parecia funcionar. `DMOB-D076` escolheu o launcher diegetico como etapa local, `DMOB-D077` foi resolvido pela publicacao Web/APK, e o foco atual e playtest humano estreito do pacote publicado Bosque Persistent Overlay Shell v1; bugs futuros voltam ao fluxo normal se aparecerem.
...
direcao: Bosque Persistent Overlay Shell v1 e o pacote publicado atual; Arena PVE segue
...
1. Playtestar o pacote publicado `Bosque Persistent Overlay Shell v1` em Web/APK, focando prompts/landmarks do Bosque, abertura de Arena/Base/Shop/Social/Profile e retorno via `Voltar`.
...
1. Rodar playtest humano do pacote publicado `Bosque Persistent Overlay Shell v1`.
