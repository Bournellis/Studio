...
Etapa operacional atual: `BOSQUE_DIEGETIC_LAUNCHER_FOUNDATION_V1_PUBLISHED_INTERNAL_ALPHA`.

Pacote remoto Internal Alpha atual: `Bosque Diegetic Launcher Foundation v1`, release root `internal-alpha/v0-bosque-diegetic-launcher-foundation-v1-20260609-e55ed0c`, evidencia `https://56b58162.draxos-mobile-internal-alpha.pages.dev`, portal oficial `https://draxos-mobile-internal-alpha.pages.dev/`, Web direto `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, versao `0.0.16-alpha.0`, version code `16`, minimum supported version code `13`.

Playtest humano inicial do pacote anterior, Bosque Bootstrap Authority v1, foi reportado OK por Fabio em 2026-06-09: tudo testado ate aquele momento parecia funcionar. `DMOB-D076` escolheu o launcher diegetico como etapa local, `DMOB-D077` foi resolvido pela publicacao Web/APK, e o foco atual e playtest humano estreito do pacote publicado Bosque Diegetic Launcher Foundation v1; bugs futuros voltam ao fluxo normal se aparecerem.
...
direcao: Bosque Diegetic Launcher Foundation v1 e o pacote publicado atual; Arena PVE segue
...
1. Playtestar o pacote publicado `Bosque Diegetic Launcher Foundation v1` em Web/APK, focando prompts/landmarks do Bosque, abertura de Arena/Base/Shop/Social/Profile e retorno via `Voltar`.
...
1. Rodar playtest humano do pacote publicado `Bosque Diegetic Launcher Foundation v1`.
