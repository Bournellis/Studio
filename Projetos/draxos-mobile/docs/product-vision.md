...
Etapa operacional atual: `BOSQUE_OVERLAY_LAYER_READINESS_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA`.

Pacote remoto Internal Alpha atual: `Bosque Overlay Layer And Readiness Authority v1`, release root `internal-alpha/v0-bosque-overlay-layer-readiness-authority-v1-20260610-181861c`, evidencia `https://a9e3b2f9.draxos-mobile-internal-alpha.pages.dev`, portal oficial `https://draxos-mobile-internal-alpha.pages.dev/`, Web direto `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, versao `0.0.23-alpha.0`, version code `23`, minimum supported version code `13`.

Playtest humano inicial do pacote anterior, Bosque Bootstrap Authority v1, foi reportado OK por Fabio em 2026-06-09: tudo testado ate aquele momento parecia funcionar. `DMOB-D076` escolheu o launcher diegetico como etapa local, `DMOB-D077` foi resolvido pela publicacao Web/APK, `DMOB-D078` publicou o overlay persistente, `DMOB-D079` publicou o primeiro hotfix de navegacao, `Bosque Arena Abandon Recovery Authority v1` preservou a recuperacao de abandono da Arena, e o foco atual e playtest humano estreito do pacote publicado Bosque Overlay Layer And Readiness Authority v1; bugs futuros voltam ao fluxo normal se aparecerem.
...
direcao: Bosque Overlay Layer And Readiness Authority v1 e o pacote publicado atual; Arena PVE segue
...
1. Playtestar o pacote publicado `Bosque Overlay Layer And Readiness Authority v1` em Web/APK, focando prompts/landmarks do Bosque, Arena fullscreen acima do menu sem corte lateral, modal global/topmost, estados `refreshing -> ready`, Social digitavel, Shop confirmavel, Arena retomar/abandonar e retorno via `Fechar`, `Voltar` e Esc.
...
1. Rodar playtest humano do pacote publicado `Bosque Overlay Layer And Readiness Authority v1`, incluindo Arena fullscreen sem corte lateral, modal global/topmost, menu readiness, Social typing/actions, Shop cancel/confirm e Arena retomar/abandonar.
