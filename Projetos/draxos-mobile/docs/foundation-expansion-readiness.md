...
- primeiros modulos de dominio portavel: `_shared/base_domain.ts` concentra regras/projecao puras da Base, e `_shared/battle_log_projection.ts` concentra projecao de `battle_log_v1`, historico e metadata de ruleset sem rerodar simulador;
