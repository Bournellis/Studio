...
O pacote operacional atual e `Bosque Diegetic Launcher Foundation v1` (`0.0.16-alpha.0`, version code `16`). Os downloads default do manifest continuam apontando para os artefatos configurados na funcao de release; nao derivar novos hashes ou URLs a partir do nome do pacote sem nova publicacao de artefatos.
