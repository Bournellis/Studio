...
const DEFAULT_MANIFEST: ReleaseManifest = {
  ...
  released_at: "2026-06-16T04:47:40Z",
  ...
  notes: [
    ...
    "Portal/Web rodam no Cloudflare Pages; downloads usam login alpha e URLs assinadas temporarias.",
  ...
  artifacts: {
    android: {
      ...
      sha256: "f759d99f113e004c4ba5e2f15d3597904cfd97c6a3277514b3c0ab1035cf3b04",
      auth_required: "true",
    },
    pc_windows: {
      ...
      sha256: "b37677c972c0c23302dab4658a2a5369f0d182f9abff064191058541f889705a",
      auth_required: "true",
    },
    web: {
      label: "Web",
...
const DEFAULT_RELEASE_ROOT =
  "internal-alpha/v0-arena-runtime-config-sync-ready-v3-20260616-bc04e88a";
