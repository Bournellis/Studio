...
const DEFAULT_MANIFEST: ReleaseManifest = {
  ...
  latest_version: "0.0.7-alpha.0",
  latest_version_code: 7,
  minimum_supported_version: "0.0.7-alpha.0",
  ...
  notes: [
    "Bosque Fogueira Potion Crafting v1 publicado na URL principal de Internal Alpha.",
    "APK Android, PC ZIP e Web compartilham o mesmo backend remoto publicado.",
    "Manifesto exige build minima 0.0.7-alpha.0 para garantir craft de pocoes via Fogueira.",
    "Fogueira Estavel I agora prepara Pocoes de Vida, Foco e Resguardo com materiais do Bau e Po de Osso.",
    "Base segue triturando Ossos; criacao direta de Pocao de Vida foi movida para o Bosque.",
