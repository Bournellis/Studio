...
const DEFAULT_MANIFEST: ReleaseManifest = {
  ...
  latest_version: "0.0.6-alpha.0",
  latest_version_code: 6,
  minimum_supported_version: "0.0.6-alpha.0",
  ...
  notes: [
    ...
    "Manifesto exige build minima 0.0.6-alpha.0 para garantir cache duravel do Bosque no cliente.",
