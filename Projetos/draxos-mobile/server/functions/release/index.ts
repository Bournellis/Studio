...
const DEFAULT_MANIFEST: ReleaseManifest = {
  ...
  notes: [
    ...
    "Manifesto exige build minima 0.0.8-alpha.0 para separar materiais locais do Bosque e recursos da Conta/Ossario.",
    "Fogueira Estavel I persiste como estrutura duravel e prepara pocoes com Bau do Bosque + Po de Osso da Conta/Ossario.",
