...
func _run_validation() -> int:
	...
	_check_project_setting("draxos_mobile/battle_lab/enabled", true)
	_check_project_setting("draxos_mobile/battle_lab/deno_command", "npx")
	_check_project_setting("draxos_mobile/progression_lab/enabled", true)
	_check_project_setting("draxos_mobile/internal_alpha/dev_tools_enabled", true)
	_check_project_setting("draxos_mobile/internal_alpha/arena_dev_fixtures_enabled", false)
	_check_project_setting("draxos_mobile/modes/openworld/enabled", true)
	_check_resource("res://modes/boot/boot.tscn")
	_check_resource("res://modes/boot/boot.gd")
	_check_resource("res://modes/boot/ui/mode_shell_launcher.gd")
	...
	_check_resource("res://modes/boot/flows/arena_dev_fixture_provider.gd")
	_check_resource("res://modes/boot/surfaces/arena_surface_presenter.gd")
	_check_resource("res://modes/boot/surfaces/mode_hub_surface_presenter.gd")
	...
	_check_resource("res://ui/battle_symbol_icon.gd")
	_check_resource("res://ui/battle_stage_2d.gd")
	...
	_check_resource("res://tools/smoke_runtime_config.gd")
	...
	_check_resource("res://tools/smoke_mode_hub.gd")
	_check_resource("res://tools/smoke_openworld_forest.gd")
	_check_resource("res://tools/smoke_modes_visual_layout.gd")
	_check_resource("res://tools/smoke_modes_ops_panel.gd")
