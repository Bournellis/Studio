...
func _run_validation() -> int:
	...
	_check_project_setting("draxos_mobile/minigames/rpgsuave/enabled", true)
	...
	_check_resource("res://dev/minigames/rpgsuave/rpgsuave_forest_model.gd")
	_check_resource("res://dev/minigames/rpgsuave/rpgsuave_forest_screen.gd")
	_check_resource("res://dev/minigames/rpgsuave/rpgsuave_forest_world_view.gd")
	_check_resource("res://dev/minigames/rpgsuave/rpgsuave_inventory_sheet.gd")
	_check_resource("res://dev/minigames/rpgsuave/rpgsuave_virtual_joystick.gd")
	...
	_check_resource("res://tools/smoke_rpgsuave_forest.gd")
	_check_resource("res://tools/smoke_rpgsuave_visual_layout.gd")
