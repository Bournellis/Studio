...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-overlay-interactive-controls-authority-v1-20260609-d3be1fb"
    $currentPreview = "https://9461e4be.draxos-mobile-internal-alpha.pages.dev"
    ...
    foreach ($entry in @(
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("BOSQUE_OVERLAY_INTERACTIVE_CONTROLS_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Bosque Overlay Menu Action Authority v1 preservado como pacote anterior de botoes internos", "Bosque Overlay Navigation Hotfix v1 preservado como hotfix de interacao anterior", "Arena PVE Bonus Visual v1 preservado como pacote Arena anterior", "Bosque Node Cooldown ACK v1 preservado como pacote Bosque anterior", "Track 13 release safety", "Track 14 agent ops") },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("BOSQUE_OVERLAY_INTERACTIVE_CONTROLS_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Bosque Overlay Menu Action Authority v1 segue preservado como pacote anterior de botoes internos", "Bosque Overlay Navigation Hotfix v1 segue preservado como hotfix de interacao anterior", "Arena PVE Bonus Visual v1 segue preservado como pacote Arena anterior", "Bosque Node Cooldown ACK v1 segue preservado como pacote Bosque anterior", "Bosque Resume Exit Lifecycle v1", "Bosque Feel & Spawn Authority v1", "Bosque Persistence Rebase v1", $previousVisibleRoot, $previousVisiblePreview, "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Bosque Overlay Interactive Controls Authority v1", $currentRoot, $currentPreview, "Previous internal-menu-button package:", $previousMenuActionRoot, $previousMenuActionPreview, "Previous interaction hotfix package:", $previousOverlayNavRoot, $previousOverlayNavPreview, "Previous bootstrap package:", $previousBootstrapRoot, $previousBootstrapPreview, "Previous Arena package:", $previousArenaBonusRoot, $previousArenaBonusPreview, "Previous Bosque package:", $previousBosqueRoot, $previousBosquePreview, "Previous resume/exit package:", $previousResumeRoot, $previousResumePreview, "Previous feel/spawn package:", $previousFeelRoot, $previousFeelPreview, "Previous persistence/operations package:", $previousPersistenceRoot, $previousPersistencePreview) }
    )) {
