...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-durable-bau-mochila-v1-20260606-6e7ca6b"
    $currentPreview = "https://39198a35.draxos-mobile-internal-alpha.pages.dev"
