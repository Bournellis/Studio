...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-overlay-navigation-hotfix-v1-20260609-9b93e5d"
    $currentPreview = "https://92cc0579.draxos-mobile-internal-alpha.pages.dev"
