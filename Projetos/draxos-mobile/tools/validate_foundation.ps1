...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-persistent-overlay-shell-v1-20260609-d05081c"
    $currentPreview = "https://a53c1d27.draxos-mobile-internal-alpha.pages.dev"
