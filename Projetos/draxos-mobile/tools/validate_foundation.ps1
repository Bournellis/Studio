...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-overlay-menu-action-authority-v1-20260609-aa9402d"
    $currentPreview = "https://5f04e6ae.draxos-mobile-internal-alpha.pages.dev"
