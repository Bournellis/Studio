...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-arena-pve-season1-loop-v1-20260605-c8baf32"
    $currentPreview = "https://d7333659.draxos-mobile-internal-alpha.pages.dev"
    ...
    foreach ($entry in @(
        @{ Base = $ProjectPath; Path = "AGENTS.md"; Needles = @("Arena PVE Season 1 Loop v1 is the latest remote Internal Alpha publication", $currentRoot, $currentPreview, "Arena Duel Flow Hotfix remains the previous hotfix package", $previousHotfixRoot, $previousHotfixPreview, "Arena PVE First Real Run + Update Recovery remains the previous Arena package", $previousArenaRoot, $previousArenaPreview, "Bosque v3 UX/Feel remains the previous content/polish package", $previousContentRoot, $previousContentPreview, "Openworld Main Menu Sync remains the previous Openworld content package", $previousOpenworldRoot, $previousOpenworldPreview, "Foundation Hardening V2 remains the previous hardening/live-doc enforcement baseline", $hardeningRoot, $hardeningPreview) },
        @{ Base = $ProjectPath; Path = "README.md"; Needles = @("Current release root:", $currentRoot, "Current verified preview:", $currentPreview, "Previous Arena release root:", $previousArenaRoot, "Previous Arena verified preview:", $previousArenaPreview, "Previous content/polish release root:", $previousContentRoot, "Previous content/polish verified preview:", $previousContentPreview, "Previous content release root:", $previousOpenworldRoot, "Previous content verified preview:", $previousOpenworldPreview, "Previous hardening release root:", $hardeningRoot, "Previous hardening verified preview:", $hardeningPreview) },
        @{ Base = $ProjectPath; Path = "implementation\current-status.md"; Needles = @("Latest published remote package:", "Arena PVE Season 1 Loop v1", $currentRoot, $currentPreview, "Previous hotfix release root:", $previousHotfixRoot, $previousHotfixPreview, "Previous Arena package:", "Arena PVE First Real Run + Update Recovery", $previousArenaRoot, $previousArenaPreview, "Previous content/polish package:", "Bosque v3 UX/Feel", $previousContentRoot, $previousContentPreview, "Previous Openworld content package:", "Openworld Main Menu Sync", $previousOpenworldRoot, $previousOpenworldPreview, "Previous hardening baseline:", "Foundation Hardening V2", $hardeningRoot, $hardeningPreview) },
        @{ Base = $ProjectPath; Path = "docs\agent-operating-manual.md"; Needles = @("Arena PVE Season 1 Loop v1 is the latest remote Internal Alpha publication", $currentRoot, $currentPreview, "Arena Duel Flow Hotfix remains the previous hotfix package", $previousHotfixRoot, $previousHotfixPreview, "Arena PVE First Real Run + Update Recovery remains the previous Arena package", $previousArenaRoot, $previousArenaPreview, "Bosque v3 UX/Feel remains the previous content/polish package", $previousContentRoot, $previousContentPreview, "Openworld Main Menu Sync remains the previous Openworld content package", $previousOpenworldRoot, $previousOpenworldPreview, "Foundation Hardening V2 is the previous hardening/live-doc enforcement baseline", $hardeningRoot, $hardeningPreview) },
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("ARENA_PVE_SEASON1_LOOP_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, $previousHotfixRoot, $previousHotfixPreview, $previousArenaRoot, $previousArenaPreview, "Bosque v3 UX/Feel", "Openworld Main Menu Sync", "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("ARENA_PVE_SEASON1_LOOP_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, $previousHotfixRoot, $previousHotfixPreview, $previousArenaRoot, $previousArenaPreview, "Bosque v3 UX/Feel", "Openworld Main Menu Sync", "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Arena PVE Season 1 Loop v1", $currentRoot, $currentPreview, "Previous hotfix package:", $previousHotfixRoot, $previousHotfixPreview, "Previous Arena package:", $previousArenaRoot, $previousArenaPreview, "Previous content/polish package: Bosque v3 UX/Feel", $previousContentRoot, $previousContentPreview, "Previous hardening guard marker: Foundation Hardening V2", $hardeningRoot, $hardeningPreview) }
    )) {
