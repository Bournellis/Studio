...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-persistence-rebase-v1-20260608-bc23f74"
    $currentPreview = "https://0c0a8dcf.draxos-mobile-internal-alpha.pages.dev"
    ...
    foreach ($entry in @(
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("BOSQUE_PERSISTENCE_REBASE_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Bosque Session Lifecycle & Durable Structures Hotfix v1 preservado como pacote anterior", "Bosque World Hub Domain Separation v1", "Bosque Fogueira Potion Crafting v1", "Bosque Durable Bau Mochila v1", "Arena PVE Menu Flow Simplification v1", "Track 13 release safety", "Track 14 agent ops") },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("BOSQUE_PERSISTENCE_REBASE_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Bosque Session Lifecycle & Durable Structures Hotfix v1 segue preservado", "Bosque World Hub Domain Separation v1", "Bosque Fogueira Potion Crafting v1", "Bosque Durable Bau Mochila v1", "Arena PVE Menu Flow Simplification v1", "Bosque Offline-First Checkpoint v1", $previousSyncRoot, $previousSyncPreview, $previousVisibleRoot, $previousVisiblePreview, "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Bosque Persistence Rebase v1", $currentRoot, $currentPreview, "Previous session-lifecycle package:", $previousSessionRoot, $previousSessionPreview, "Previous local/account domain package:", $previousWorldRoot, $previousWorldPreview, "Previous station-craft package:", $previousStationRoot, $previousStationPreview, "Previous durable Openworld package:", $previousDurableRoot, $previousDurablePreview, "Previous Arena menu package:", $previousMenuRoot, $previousMenuPreview) }
    )) {
