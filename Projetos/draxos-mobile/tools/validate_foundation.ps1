...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-fogueira-potion-crafting-v1-20260606-cad6d2c"
    $currentPreview = "https://08d00f24.draxos-mobile-internal-alpha.pages.dev"
    ...
    foreach ($entry in @(
        @{ Base = $ProjectPath; Path = "AGENTS.md"; Needles = @("Bosque Fogueira Potion Crafting v1 is the latest remote Internal Alpha publication", $currentRoot, $currentPreview, "Bosque Durable Bau Mochila v1 remains the previous durable Openworld", $previousDurableRoot, $previousDurablePreview, "Arena PVE Menu Flow Simplification v1 remains the previous Arena menu package", $previousMenuRoot, $previousMenuPreview, "Bosque Offline-First Checkpoint v1 remains the previous Openworld policy package", $previousCheckpointRoot, $previousCheckpointPreview, "Bosque Sync Responsiveness v1 remains the previous Bosque sync package", $previousSyncRoot, $previousSyncPreview, "Arena/Bosque Visible V2 remains the previous visible package", $previousVisibleRoot, $previousVisiblePreview, "Arena/Bosque Regression Hotfix remains the previous visibility hotfix package", $previousRegressionRoot, $previousRegressionPreview, "Arena PVE Season 1 Loop v1 remains the previous Season 1 package", $previousSeasonRoot, $previousSeasonPreview) },
        @{ Base = $ProjectPath; Path = "README.md"; Needles = @("Current release root:", $currentRoot, "Current verified preview:", $currentPreview, "Previous durable Openworld release root:", $previousDurableRoot, "Previous durable Openworld verified preview:", $previousDurablePreview, "Previous Arena menu release root:", $previousMenuRoot, "Previous Arena menu verified preview:", $previousMenuPreview, "Previous Openworld policy release root:", $previousCheckpointRoot, "Previous Openworld policy verified preview:", $previousCheckpointPreview, "Previous Bosque sync release root:", $previousSyncRoot, "Previous Bosque sync verified preview:", $previousSyncPreview, "Previous visible release root:", $previousVisibleRoot, "Previous visible verified preview:", $previousVisiblePreview, "Previous visibility hotfix release root:", $previousRegressionRoot, "Previous visibility hotfix verified preview:", $previousRegressionPreview, "Previous Season 1 release root:", $previousSeasonRoot, "Previous Season 1 verified preview:", $previousSeasonPreview, "Previous Arena release root:", $previousArenaRoot, "Previous Arena verified preview:", $previousArenaPreview, "Previous content/polish release root:", $previousContentRoot, "Previous content/polish verified preview:", $previousContentPreview, "Previous content release root:", $previousOpenworldRoot, "Previous content verified preview:", $previousOpenworldPreview, "Previous hardening release root:", $hardeningRoot, "Previous hardening verified preview:", $hardeningPreview) },
        @{ Base = $ProjectPath; Path = "implementation\current-status.md"; Needles = @("Latest published remote package:", "Bosque Fogueira Potion Crafting v1", $currentRoot, $currentPreview, "Previous durable Openworld package:", "Bosque Durable Bau Mochila v1", $previousDurableRoot, $previousDurablePreview, "Previous Arena menu package:", "Arena PVE Menu Flow Simplification v1", $previousMenuRoot, $previousMenuPreview, "Previous Openworld/Bosque policy package:", "Bosque Offline-First Checkpoint v1", $previousCheckpointRoot, $previousCheckpointPreview, "Previous Bosque sync package:", "Bosque Sync Responsiveness v1", $previousSyncRoot, $previousSyncPreview, "Previous visible package:", "Arena/Bosque Visible V2", $previousVisibleRoot, $previousVisiblePreview, "Previous visibility hotfix package:", "Arena/Bosque Regression Hotfix", $previousRegressionRoot, $previousRegressionPreview, "Previous Arena Season 1 package:", "Arena PVE Season 1 Loop v1", $previousSeasonRoot, $previousSeasonPreview, "Previous duel-flow hotfix release root:", $previousHotfixRoot, $previousHotfixPreview, "Previous Arena package:", "Arena PVE First Real Run + Update Recovery", $previousArenaRoot, $previousArenaPreview, "Previous content/polish package:", "Bosque v3 UX/Feel", $previousContentRoot, $previousContentPreview, "Previous Openworld content package:", "Openworld Main Menu Sync", $previousOpenworldRoot, $previousOpenworldPreview, "Previous hardening baseline:", "Foundation Hardening V2", $hardeningRoot, $hardeningPreview) },
        @{ Base = $ProjectPath; Path = "docs\agent-operating-manual.md"; Needles = @("Bosque Fogueira Potion Crafting v1 is the latest remote Internal Alpha publication", $currentRoot, $currentPreview, "Bosque Durable Bau Mochila v1 remains the previous durable Openworld progress package", $previousDurableRoot, $previousDurablePreview, "Arena PVE Menu Flow Simplification v1 remains the previous Arena menu package", $previousMenuRoot, $previousMenuPreview, "Bosque Offline-First Checkpoint v1 remains the previous Openworld policy package", $previousCheckpointRoot, $previousCheckpointPreview, "Bosque Sync Responsiveness v1 remains the previous Bosque sync package", "Arena/Bosque Visible V2", "Arena/Bosque Regression Hotfix", "Arena PVE Season 1 Loop v1", "Foundation Hardening V2 remains the previous hardening/live-doc enforcement baseline") },
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("BOSQUE_FOGUEIRA_POTION_CRAFTING_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, $previousDurableRoot, $previousDurablePreview, $previousMenuRoot, $previousMenuPreview, $previousCheckpointRoot, $previousCheckpointPreview, $previousSyncRoot, $previousSyncPreview, $previousVisibleRoot, $previousVisiblePreview, $previousRegressionRoot, $previousRegressionPreview, $previousSeasonRoot, $previousSeasonPreview, $previousHotfixRoot, $previousHotfixPreview, $previousArenaRoot, $previousArenaPreview, "Bosque v3 UX/Feel", "Openworld Main Menu Sync", "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("BOSQUE_FOGUEIRA_POTION_CRAFTING_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, $previousDurableRoot, $previousDurablePreview, $previousMenuRoot, $previousMenuPreview, $previousCheckpointRoot, $previousCheckpointPreview, $previousSyncRoot, $previousSyncPreview, $previousVisibleRoot, $previousVisiblePreview, $previousRegressionRoot, $previousRegressionPreview, $previousSeasonRoot, $previousSeasonPreview, $previousHotfixRoot, $previousHotfixPreview, $previousArenaRoot, $previousArenaPreview, "Bosque v3 UX/Feel", "Openworld Main Menu Sync", "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Bosque Fogueira Potion Crafting v1", $currentRoot, $currentPreview, "Previous durable Openworld package:", $previousDurableRoot, $previousDurablePreview, "Previous Arena menu package:", $previousMenuRoot, $previousMenuPreview, "Previous Openworld policy package:", $previousCheckpointRoot, $previousCheckpointPreview, "Previous Bosque sync package:", $previousSyncRoot, $previousSyncPreview, "Previous visible package:", $previousVisibleRoot, $previousVisiblePreview, "Previous visibility hotfix package:", $previousRegressionRoot, $previousRegressionPreview, "Previous Season 1 package:", $previousSeasonRoot, $previousSeasonPreview, "Previous duel-flow hotfix package:", $previousHotfixRoot, $previousHotfixPreview, "Previous Arena package:", $previousArenaRoot, $previousArenaPreview, "Previous content/polish package: Bosque v3 UX/Feel", $previousContentRoot, $previousContentPreview, "Previous hardening guard marker: Foundation Hardening V2", $hardeningRoot, $hardeningPreview) }
    )) {
