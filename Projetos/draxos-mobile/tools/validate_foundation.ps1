...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-arena-abandon-recovery-authority-v1-20260610-a252241"
    $currentPreview = "https://b149da8f.draxos-mobile-internal-alpha.pages.dev"
