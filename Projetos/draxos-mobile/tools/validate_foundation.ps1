...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-feel-spawn-authority-v1-20260608-70b79c3"
    $currentPreview = "https://16ac3cb7.draxos-mobile-internal-alpha.pages.dev"
    ...
    foreach ($entry in @(
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("BOSQUE_FEEL_SPAWN_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Bosque Persistence Rebase v1 preservado como pacote anterior", "Bosque Session Lifecycle & Durable Structures Hotfix v1 preservado como pacote anterior", "Bosque World Hub Domain Separation v1", "Bosque Fogueira Potion Crafting v1", "Bosque Durable Bau Mochila v1", "Arena PVE Menu Flow Simplification v1", "Track 13 release safety", "Track 14 agent ops") },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("BOSQUE_FEEL_SPAWN_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Bosque Persistence Rebase v1 segue preservado", "Bosque Session Lifecycle & Durable Structures Hotfix v1 segue preservado", "Bosque World Hub Domain Separation v1", "Bosque Fogueira Potion Crafting v1", "Bosque Durable Bau Mochila v1", "Arena PVE Menu Flow Simplification v1", "Bosque Offline-First Checkpoint v1", $previousSyncRoot, $previousSyncPreview, $previousVisibleRoot, $previousVisiblePreview, "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Bosque Feel & Spawn Authority v1", $currentRoot, $currentPreview, "Previous persistence/operations package:", $previousPersistenceRoot, $previousPersistencePreview, "Previous session-lifecycle package:", $previousSessionRoot, $previousSessionPreview, "Previous local/account domain package:", $previousWorldRoot, $previousWorldPreview, "Previous station-craft package:", $previousStationRoot, $previousStationPreview, "Previous durable Openworld package:", $previousDurableRoot, $previousDurablePreview, "Previous Arena menu package:", $previousMenuRoot, $previousMenuPreview) }
    )) {
