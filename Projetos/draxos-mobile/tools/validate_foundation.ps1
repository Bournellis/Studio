...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-bootstrap-authority-v1-20260609-ba99e70"
    $currentPreview = "https://0123894f.draxos-mobile-internal-alpha.pages.dev"
    ...
    foreach ($entry in @(
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("BOSQUE_BOOTSTRAP_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Arena PVE Bonus Visual v1 preservado como pacote Arena anterior", "Bosque Node Cooldown ACK v1 preservado como pacote Bosque anterior", "Track 13 release safety", "Track 14 agent ops") },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("BOSQUE_BOOTSTRAP_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Arena PVE Bonus Visual v1 segue preservado como pacote Arena anterior", "Bosque Node Cooldown ACK v1 segue preservado como pacote Bosque anterior", "Bosque Resume Exit Lifecycle v1", "Bosque Feel & Spawn Authority v1", "Bosque Persistence Rebase v1", $previousVisibleRoot, $previousVisiblePreview, "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Bosque Bootstrap Authority v1", $currentRoot, $currentPreview, "Previous Arena package:", $previousArenaBonusRoot, $previousArenaBonusPreview, "Previous Bosque package:", $previousBosqueRoot, $previousBosquePreview, "Previous resume/exit package:", $previousResumeRoot, $previousResumePreview, "Previous feel/spawn package:", $previousFeelRoot, $previousFeelPreview, "Previous persistence/operations package:", $previousPersistenceRoot, $previousPersistencePreview) }
    )) {
