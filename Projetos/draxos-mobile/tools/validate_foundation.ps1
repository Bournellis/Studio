...
function Assert-LiveDocsReleaseRootFreshness {
    ...
    foreach ($entry in @(
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("ARENA_BOSQUE_VISIBLE_V2_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, $previousVisibleRoot, $previousVisiblePreview, $previousSeasonRoot, $previousSeasonPreview, $previousHotfixRoot, $previousHotfixPreview, $previousArenaRoot, $previousArenaPreview, "Bosque v3 UX/Feel", "Openworld Main Menu Sync", "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("ARENA_BOSQUE_VISIBLE_V2_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, $previousVisibleRoot, $previousVisiblePreview, $previousSeasonRoot, $previousSeasonPreview, $previousHotfixRoot, $previousHotfixPreview, $previousArenaRoot, $previousArenaPreview, "Bosque v3 UX/Feel", "Openworld Main Menu Sync", "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Arena/Bosque Visible V2", $currentRoot, $currentPreview, "Previous visibility hotfix package:", $previousVisibleRoot, $previousVisiblePreview, "Previous Season 1 package:", $previousSeasonRoot, $previousSeasonPreview, "Previous duel-flow hotfix package:", $previousHotfixRoot, $previousHotfixPreview, "Previous Arena package:", $previousArenaRoot, $previousArenaPreview, "Previous content/polish package: Bosque v3 UX/Feel", $previousContentRoot, $previousContentPreview, "Previous hardening guard marker: Foundation Hardening V2", $hardeningRoot, $hardeningPreview) }
    )) {
