...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-arena-duel-flow-hotfix-20260605-7ce5174"
    $currentPreview = "https://0536635b.draxos-mobile-internal-alpha.pages.dev"
    ...
    foreach ($entry in @(
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("ARENA_DUEL_FLOW_HOTFIX_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, $previousArenaRoot, $previousArenaPreview, "Bosque v3 UX/Feel", "Openworld Main Menu Sync", "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("ARENA_DUEL_FLOW_HOTFIX_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, $previousArenaRoot, $previousArenaPreview, "Bosque v3 UX/Feel", "Openworld Main Menu Sync", "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Arena Duel Flow Hotfix", $currentRoot, $currentPreview, "Previous Arena package:", $previousArenaRoot, $previousArenaPreview, "Previous content/polish package: Bosque v3 UX/Feel", $previousContentRoot, $previousContentPreview, "Previous hardening guard marker: Foundation Hardening V2", $hardeningRoot, $hardeningPreview) }
    )) {
