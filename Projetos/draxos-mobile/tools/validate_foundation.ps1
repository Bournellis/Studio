...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-bosque-diegetic-launcher-foundation-v1-20260609-e55ed0c"
    $currentPreview = "https://56b58162.draxos-mobile-internal-alpha.pages.dev"
