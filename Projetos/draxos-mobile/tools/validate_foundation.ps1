...
function Assert-LiveDocsReleaseRootFreshness {
    ...
    foreach ($entry in @(
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("BOSQUE_V3_UX_FEEL_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Openworld Main Menu Sync", $previousContentRoot, $previousContentPreview, "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("BOSQUE_V3_UX_FEEL_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Openworld Main Menu Sync", $previousContentRoot, $previousContentPreview, "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Bosque v3 UX/Feel", $currentRoot, $currentPreview, "Previous content package: Openworld Main Menu Sync", $previousContentRoot, $previousContentPreview, "Previous hardening guard marker: Foundation Hardening V2", $hardeningRoot, $hardeningPreview) }
    )) {
