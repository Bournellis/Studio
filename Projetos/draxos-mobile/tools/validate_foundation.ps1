...
function Assert-LiveDocsReleaseRootFreshness {
    ...
    foreach ($entry in @(
        @{ Base = $ProjectPath; Path = "AGENTS.md"; Needles = @("Technical Hardening is the latest remote Internal Alpha publication", $currentRoot, $currentPreview, "Openworld Main Menu Sync remains the previous content package", $previousContentRoot, $previousContentPreview, "Foundation Hardening V2 remains the previous hardening/live-doc enforcement baseline", $hardeningRoot, $hardeningPreview) },
        @{ Base = $ProjectPath; Path = "README.md"; Needles = @("Current release root:", $currentRoot, "Current verified preview:", $currentPreview, "Previous content release root:", $previousContentRoot, "Previous content verified preview:", $previousContentPreview, "Previous hardening release root:", $hardeningRoot, "Previous hardening verified preview:", $hardeningPreview) },
        @{ Base = $ProjectPath; Path = "implementation\current-status.md"; Needles = @("Latest published remote package:", "Technical Hardening", $currentRoot, $currentPreview, "Previous content package:", "Openworld Main Menu Sync", $previousContentRoot, $previousContentPreview, "Previous hardening baseline:", "Foundation Hardening V2", $hardeningRoot, $hardeningPreview) },
        @{ Base = $ProjectPath; Path = "docs\agent-operating-manual.md"; Needles = @("Technical Hardening is the latest remote Internal Alpha publication", $currentRoot, $currentPreview, "Openworld Main Menu Sync remains the previous content package", $previousContentRoot, $previousContentPreview, "Foundation Hardening V2 is the previous hardening/live-doc enforcement baseline", $hardeningRoot, $hardeningPreview) },
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("TECHNICAL_HARDENING_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Openworld Main Menu Sync", $previousContentRoot, $previousContentPreview, "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("TECHNICAL_HARDENING_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Openworld Main Menu Sync", $previousContentRoot, $previousContentPreview, "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Technical Hardening", $currentRoot, $currentPreview, "Previous content package: Openworld Main Menu Sync", $previousContentRoot, $previousContentPreview, "Previous hardening guard marker: Foundation Hardening V2", $hardeningRoot, $hardeningPreview) }
    )) {
