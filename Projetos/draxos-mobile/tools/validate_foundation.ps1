...
function Assert-LiveDocsReleaseRootFreshness {
    $currentRoot = "internal-alpha/v0-arena-pve-menu-flow-simplification-v1-20260606-5d03a68"
    $currentPreview = "https://fdf44707.draxos-mobile-internal-alpha.pages.dev"
