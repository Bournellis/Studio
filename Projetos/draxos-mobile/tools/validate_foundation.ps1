...
function Assert-LiveDocsReleaseRootFreshness {
    ...
    foreach ($entry in @(
        ...
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Prioridades_Estudio.md"; Needles = @("ARENA_PVE_FIRST_REAL_RUN_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Bosque v3 UX/Feel", $previousContentRoot, $previousContentPreview, "Openworld Main Menu Sync", $previousOpenworldRoot, $previousOpenworldPreview, "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "08_Coordenacao_Agentes\Estado_Atual.md"; Needles = @("ARENA_PVE_FIRST_REAL_RUN_PUBLISHED_INTERNAL_ALPHA", $currentRoot, $currentPreview, "Bosque v3 UX/Feel", $previousContentRoot, $previousContentPreview, "Openworld Main Menu Sync", $previousOpenworldRoot, $previousOpenworldPreview, "FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA", $hardeningRoot, $hardeningPreview) },
        @{ Base = $RepoPath; Path = "Projetos\README.md"; Needles = @("Current published package:", "Arena PVE First Real Run + Update Recovery", $currentRoot, $currentPreview, "Previous content/polish package: Bosque v3 UX/Feel", $previousContentRoot, $previousContentPreview, "Previous hardening guard marker: Foundation Hardening V2", $hardeningRoot, $hardeningPreview) }
    )) {
