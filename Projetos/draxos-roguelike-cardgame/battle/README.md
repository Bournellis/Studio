...
- automatic attacks choose the opposing front slot, then the nearest enemy `defensor` when the lane is empty, then direct hero damage when the mode allows it
