...
- `track-01-playable-run-loop/`: complete playable 13-map slice baseline.
...
Track 01 owns the transition from placeholder screens into a coherent playable 13-map run loop.
