...
Track 02 is ready for user playtest. Use `docs/playtest-track-02.md` for the human checklist and `tracks/track-02-complete-run-evolution/validation-and-tuning-notes.md` for metrics and known debt; use AutoRun Gate Pack V1 for explicit macro-route regression/tuning comparison and Scenario Fixtures V1 for small deterministic regression signals, not as substitutes for human playtest.
