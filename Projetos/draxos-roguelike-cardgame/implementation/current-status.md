...
Track 02 is ready for user playtest and for a slightly larger card-change batch using the same lab stack. Use `docs/playtest-track-02.md` for the human checklist and `tracks/track-02-complete-run-evolution/validation-and-tuning-notes.md` for metrics and known debt; use Card Impact Pack V1 before/change/after/compare for card-specific movement, then decide whether the player-card harness needs log-derived effect deltas beyond final HP/turn metrics.
