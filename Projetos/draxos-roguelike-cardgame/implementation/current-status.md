...
Track 02 is ready for user playtest and for the first real card-change batch using the lab stack. Use `docs/playtest-track-02.md` for the human checklist and `tracks/track-02-complete-run-evolution/validation-and-tuning-notes.md` for metrics and known debt; use AutoRun Gate Pack V1 for explicit macro-route regression/tuning comparison, Scenario Fixtures V1 for small deterministic route/economy/deck signals, Gameplay Lab V1 for isolated real BattleEngine combat regression signals, Lab Diff Reporter V1 for before/after diffs and Card Impact Pack V1 for card-specific before/change/after/compare impact reads, not as substitutes for human playtest.
