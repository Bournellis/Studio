...
Track 02 is ready for user playtest. Use `tracks/track-02-complete-run-evolution/validation-and-tuning-notes.md` for P09 metrics and known debt; use the local Run Lab only for regression and tuning comparison, not as a substitute for human playtest.
