...
- Status: `FPS_PLAYGROUND_TRACK14D_PICKUPS_JUMP_PADS_LOCAL_VALIDATED`
- Current surface: FPS arena lab.
- Current baseline: Track 12 telemetry/readout approved; Track 13 docs rebaseline complete; Track 14D pickups/jump pads local validated; current player movement feel preserved.
