...
func _check_core_project_contract() -> void:
	...
	_check_resource("res://gameplay/telemetry/arena_telemetry_recorder.gd")
	_check_resource("res://gameplay/telemetry/telemetry_readout_analyzer.gd")
	...
	_check_resource("res://tools/telemetry_readout.gd")
...
func _check_documentation_contract() -> void:
	...
	_check_resource("res://docs/telemetry.md")
	_check_resource("res://docs/telemetry-readout.md")
	_check_resource("res://docs/balance-baseline.md")
