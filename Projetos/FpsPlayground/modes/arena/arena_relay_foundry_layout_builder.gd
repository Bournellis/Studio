...
static func build(parent: Node3D, config: Dictionary) -> Dictionary:
	...
	_add_visual_box(parent, "RelayLaneMark", Vector3(0.0, 0.026, 0.0), Vector3(27.0, 0.05, 0.82), Color(0.18, 0.66, 0.72, 1.0))
	_add_visual_box(parent, "FoundryLaneMark", Vector3(0.0, 0.027, 7.4), Vector3(22.0, 0.05, 0.72), Color(0.58, 0.24, 0.5, 1.0))
	_add_visual_box(parent, "RelayNorthMark", Vector3(-8.2, 0.028, -8.7), Vector3(8.0, 0.05, 0.72), Color(0.12, 0.78, 0.9, 1.0))
	_add_visual_box(parent, "ForgeSouthMark", Vector3(8.2, 0.028, 8.5), Vector3(8.0, 0.05, 0.72), Color(0.74, 0.42, 1.0, 1.0))

	_add_box(parent, "RelayCore", Vector3(0.0, 1.65, 0.0), Vector3(4.4, 3.3, 4.8), Color(0.2, 0.24, 0.28, 1.0))
	_add_box(parent, "NorthCoreCover", Vector3(-3.3, 0.62, -5.9), Vector3(4.0, 1.24, 1.1), Color(0.24, 0.34, 0.39, 1.0), Vector3(0.0, -16.0, 0.0))
	_add_box(parent, "SouthCoreCover", Vector3(3.5, 0.62, 5.7), Vector3(4.0, 1.24, 1.1), Color(0.32, 0.26, 0.42, 1.0), Vector3(0.0, -16.0, 0.0))
	_add_box(parent, "WestRelayCover", Vector3(-9.6, 1.2, 1.7), Vector3(1.2, 2.4, 4.8), Color(0.21, 0.32, 0.37, 1.0))
	_add_box(parent, "EastForgeCover", Vector3(8.8, 1.2, -1.4), Vector3(1.2, 2.4, 4.8), Color(0.29, 0.25, 0.4, 1.0))
	_add_box(parent, "PlayerSpawnCover", Vector3(-13.4, 1.1, 5.0), Vector3(3.2, 2.2, 0.9), Color(0.22, 0.32, 0.39, 1.0))
	_add_box(parent, "BotSpawnCover", Vector3(13.0, 1.1, -4.5), Vector3(3.2, 2.2, 0.9), Color(0.34, 0.24, 0.38, 1.0))
	_add_box(parent, "NorthResetCover", Vector3(-13.6, 0.6, -9.6), Vector3(2.2, 1.2, 1.2), Color(0.22, 0.32, 0.39, 1.0))
	_add_box(parent, "SouthResetCover", Vector3(13.4, 0.6, 9.2), Vector3(2.2, 1.2, 1.2), Color(0.34, 0.24, 0.38, 1.0))

	_add_box(parent, "WestRelayPlatform", Vector3(-11.0, 2.78, -8.4), Vector3(7.2, 0.58, 3.4), Color(0.16, 0.28, 0.34, 1.0))
	_add_box(parent, "EastForgePlatform", Vector3(9.2, 2.78, 7.2), Vector3(7.2, 0.58, 3.4), Color(0.23, 0.18, 0.34, 1.0))
	_add_box(parent, "WestRelayRamp", Vector3(-10.0, 0.58, -5.0), Vector3(4.6, 0.32, 5.8), Color(0.19, 0.38, 0.43, 1.0), Vector3(-13.0, 0.0, 0.0))
	_add_box(parent, "EastForgeRamp", Vector3(8.3, 0.58, 4.1), Vector3(4.6, 0.32, 5.8), Color(0.4, 0.25, 0.52, 1.0), Vector3(13.0, 0.0, 0.0))
	high_platform_cover_count += _add_high_platform_cover(parent, "WestRelaySoftCover", Vector3(-12.5, 3.48, -7.2), Vector3(2.1, 0.82, 0.34), Color(0.16, 0.36, 0.44, 1.0))
	high_platform_cover_count += _add_high_platform_cover(parent, "WestRelayAngleCover", Vector3(-8.1, 3.52, -9.7), Vector3(0.36, 0.95, 1.7), Color(0.16, 0.36, 0.44, 1.0))
	high_platform_cover_count += _add_high_platform_cover(parent, "EastForgeSoftCover", Vector3(10.8, 3.48, 6.0), Vector3(2.1, 0.82, 0.34), Color(0.36, 0.24, 0.5, 1.0))
	high_platform_cover_count += _add_high_platform_cover(parent, "EastForgeAngleCover", Vector3(6.5, 3.52, 8.6), Vector3(0.36, 0.95, 1.7), Color(0.36, 0.24, 0.5, 1.0))

	flow_marker_count += _add_flow_marker(parent, "WestRelayPadApproachMark", Vector3(-12.8, 0.032, -0.6), Vector3(1.35, 0.05, 3.8), Color(0.08, 0.74, 0.9, 1.0))
	flow_marker_count += _add_flow_marker(parent, "EastForgePadApproachMark", Vector3(11.8, 0.032, 0.6), Vector3(1.35, 0.05, 3.8), Color(0.74, 0.42, 1.0, 1.0))
