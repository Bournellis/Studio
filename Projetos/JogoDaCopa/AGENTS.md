...
- default match mode is a 3-minute timer with golden goal on draw; `3 gols` remains selectable;
- runtime Copa-style stadium, roofed goals, real skinned avatars, loose arcade ball and feedback;
...
- Prefer runtime-generated primitive meshes and collision for new structural arena pieces unless a local track explicitly adopts authored assets.

## Architecture Rule

- `autoloads/`: input/bootstrap only.
- `gameplay/avatar/`: avatar visuals, Quaternius/UAL model integration and kit selection.
