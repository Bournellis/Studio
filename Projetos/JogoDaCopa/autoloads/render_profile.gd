...
const DESKTOP_TONEMAP_EXPOSURE: float = 1.0
const DESKTOP_TONEMAP_WHITE: float = 1.64
const DESKTOP_GLOW_INTENSITY: float = 0.34
const DESKTOP_GLOW_STRENGTH: float = 0.74
const DESKTOP_GLOW_BLOOM: float = 0.22
const DESKTOP_GLOW_HDR_THRESHOLD: float = 0.94
const DESKTOP_GLOW_HDR_SCALE: float = 1.36
const DESKTOP_GLOW_HDR_LUMINANCE_CAP: float = 7.2
...
const DESKTOP_MENU_PREVIEW_TONEMAP_EXPOSURE: float = 1.12
...
const WEB_TONEMAP_EXPOSURE: float = 1.0
const WEB_TONEMAP_WHITE: float = 1.54
const WEB_GLOW_INTENSITY: float = 0.36
const WEB_GLOW_STRENGTH: float = 0.72
const WEB_GLOW_BLOOM: float = 0.22
const WEB_GLOW_HDR_THRESHOLD: float = 0.9
const WEB_GLOW_HDR_SCALE: float = 1.38
const WEB_GLOW_HDR_LUMINANCE_CAP: float = 7.4
...
const WEB_DEFAULT_EMISSION_MULTIPLIER: float = 1.04
const WEB_NEON_EMISSION_MULTIPLIER: float = 1.02
const WEB_GLASS_EMISSION_MULTIPLIER: float = 0.82
const WEB_SCOREBOARD_EMISSION_MULTIPLIER: float = 1.08
const WEB_SHADER_PITCH_EMISSION_MULTIPLIER: float = 1.0
const WEB_SHADER_NET_EMISSION_MULTIPLIER: float = 0.96
const WEB_SHADER_CROWD_EMISSION_MULTIPLIER: float = 1.05
const WEB_SHADER_FLAG_EMISSION_MULTIPLIER: float = 1.04
const WEB_SHADER_HALO_EMISSION_MULTIPLIER: float = 1.08
const WEB_CHARACTER_EMISSION_MULTIPLIER: float = 1.08
const WEB_PARTICLE_EMISSION_MULTIPLIER: float = 1.08
...
const WEB_MENU_PREVIEW_TONEMAP_EXPOSURE: float = 1.12
