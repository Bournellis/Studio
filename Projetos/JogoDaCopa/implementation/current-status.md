...
Track 06D HUD Broadcast V1 is approved and merged locally in `main` as merge commit `d7d207ea`. The public Web baseline remains `v1.0.3+ef9c5baa` at `https://copa-arena-futebol.pages.dev/`; 06E is the next publication/retest track.
...
Latest Track 06D branch result: PASS, 98 tests, 1548 asserts, including night luma gate `< 90`, source integrity check and UTF-8 BOM rejection.
