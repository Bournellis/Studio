...
- Active stage: `Track 06B - ESC Menu Completo V1`
- Active stage status: `READY_FOR_REVIEW_PRE_MERGE - branch codex/jogodacopa/track06b-esc-menu-v1 validated locally; stop before merge/publication`
- Status marker: `JOGO_DA_COPA_TRACK_06B_ESC_MENU_V1_READY_FOR_REVIEW_LOCAL`
- Approved plan: Track 06B implements the complete ESC menu and persistent runtime settings after the 06A merge. Remote publication remains governed by `../../08_Coordenacao_Agentes/Decisoes/2026-06-12_jogodacopa_publicacao-web-cloudflare.md` and is deferred to 06E.
...
Track 06B ESC Menu Completo V1 is ready for Fabio/Claude review before merge. The public Web baseline remains `v1.0.3+ef9c5baa` at `https://copa-arena-futebol.pages.dev/`; no 06A/06B publication before 06E. Next step: review Track 06B, then merge locally into `main` if approved.
