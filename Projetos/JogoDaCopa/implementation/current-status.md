...
`Super Campeao v1.2.1+ff9cb389` is public at `https://copa-arena-futebol.pages.dev/` with release root `web/v1-copa-arena-futebol-20260615-ff9cb389`. Track 09A remote gates passed and Fabio reported the human test as completed. Track 09C is a local validated reduction step; public URL remains unchanged until Fabio chooses a new publish.
