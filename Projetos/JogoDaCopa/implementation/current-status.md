...
`Super Campeao v1.2.1+ff9cb389` is public at `https://copa-arena-futebol.pages.dev/` with release root `web/v1-copa-arena-futebol-20260615-ff9cb389`. Track 09A remote gates passed; next public gate remains human retest by Fabio + external tester.
