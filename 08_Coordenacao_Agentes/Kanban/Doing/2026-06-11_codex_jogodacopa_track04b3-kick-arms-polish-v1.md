...
Fora de escopo: pernas, pelvis, tronco, timing do clipe, gameplay, camera runtime, menus, audio, cenas geradas, merge em `main`, rede git (`push`/`fetch`/`pull`) e `git clean`.
...
Parar na branch com validacao PASS, evidencias visuais e `WORKTREE_VERIFIED`, aguardando review de Claude + aprovacao visual de Fabio. Nao mergear.
