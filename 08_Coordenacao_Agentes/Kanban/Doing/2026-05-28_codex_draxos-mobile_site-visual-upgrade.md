...
- Merge para `master`: resolvido preservando Track 16 e integrando portal/Grimorio/downloads.
- Publicacao Cloudflare Pages: passou em `https://b16705ab.draxos-mobile-internal-alpha.pages.dev`.
- Preview remoto: `/portal/index.html` retornou `200 text/html` com assets visuais; `/web/index.html` retornou `200 text/html` com `GODOT_CONFIG`; `hub-ritual-hall.jpg` retornou `200 image/jpeg`.
