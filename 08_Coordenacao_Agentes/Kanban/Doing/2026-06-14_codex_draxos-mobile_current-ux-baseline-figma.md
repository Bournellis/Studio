# DraxosMobile - Current UX Baseline Figma
...
Verificar disponibilidade/quota do Figma MCP e continuar a montagem do arquivo `DraxosMobile Current UX Baseline` em `https://www.figma.com/design/cIseq2iBjQwhbHs4Xp2xks`, respeitando o limite Starter de 3 paginas e usando tokens/contratos de producao como fonte unica.

## Escopo Pretendido

- Inspecao e escrita no arquivo Figma alvo
- Estrutura compacta de 3 paginas: `00 - Foundation`, `01 - UX Flow + Screens`, `99 - Archive`
- Variaveis, text styles, swatches, contrato responsivo e atomos em `00 - Foundation`
- Placeholders/reconstrucoes de fluxo atual em `01 - UX Flow + Screens`
- Sem editar arquivos locais de `Projetos/draxos-mobile` nesta rodada
...
- `Projetos/draxos-mobile/core/ui_tokens.gd`
