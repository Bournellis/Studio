...
- Publicacao local: `internal-alpha/v0-track21-arena-loop-20260531-local`; remote deploy nao executado.
- Handoff: testar novo save em remoto apos deploy aprovado: tutorial -> continuar na Arena -> primeira arena 3 duelos desbloqueada -> start direto sem confirmacao redundante.
