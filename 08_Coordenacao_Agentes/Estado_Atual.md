...
- Proximo passo: revisar se campos card-flow V4.1 devem virar expectativas promovidas, entao executar o proximo batch maior de reward cards sob V4.1 before/change/after/compare; assinaturas causais de cartas inimigas seguem como follow-up tecnico. Track 02 segue pronta para playtest de usuario da rota completa.
