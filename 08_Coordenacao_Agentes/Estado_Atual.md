...
- Proximo passo: revisar manualmente o hotfix publicado em Android/Windows/Web; confirmar Labs Dev, Refugio/Batalha contidos, download APK sem erro de Bearer token e loop pos-login antes de mover foco para social.
