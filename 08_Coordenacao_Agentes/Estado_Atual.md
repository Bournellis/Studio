...
- Tech probe P2 de implementacao: `Projetos/FpsShooter/` (`FPS_SHOOTER_TRACK_02A_BOT_PRESSURE_JUMP_HOTFIX_COMPLETE`; PC Windows editor-first FPS 3D independente com tema Draxos leve; proximo passo: playtest humano de 5 minutos focado em rifle vs Plasma Bolt, pickups, overcharge, pressao/salto do bot e leitura do duelo)
...
- Proximo passo: playtest humano de 5 minutos do `Duel Pit V1` focado em rifle vs Plasma Bolt, pickups, overcharge, bot mantendo pressao antes de buscar cura, salto simples em rampas/plataformas, dodge de plasma e justica do loop; depois decidir entre tuning de armas/recursos ou primeira expansao de verticalidade/hazards.
