...
- Foco P2 de implementacao: `Projetos/draxos-mobile/` (`OPENWORLD_QOL_REGRESSION_FIX_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-openworld-node2d-qol-hotfix-20260601-ba6f129`, production URL `https://draxos-mobile-internal-alpha.pages.dev`, deployment evidence `https://95f403c5.draxos-mobile-internal-alpha.pages.dev`, preservando Foundation Hardening V2 (`FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`) e Hardening Platform V1 como baselines anteriores, Track 21 Arena Loop Unlock/Friction como contexto do Autobattler, Track 20 Season 1 Arena Calibration, Remote Lab Runner, Track 13 release safety e Track 14 agent ops)
...
- Status: **P2_IMPLEMENTACAO - OPENWORLD_QOL_REGRESSION_FIX_PUBLISHED_INTERNAL_ALPHA**
- Fase: `Implementacao`
...
- Baseline atual: Openworld QoL regression fix publicado como Internal Alpha no release root `internal-alpha/v0-openworld-node2d-qol-hotfix-20260601-ba6f129`, production URL `https://draxos-mobile-internal-alpha.pages.dev` e deployment evidence `https://95f403c5.draxos-mobile-internal-alpha.pages.dev`, com WASD/setas por evento real/fallback Web, joystick livre mouse/touch oculto em repouso, colisao de bau/arvores/rochas, bordas bloqueantes, y-depth/layers, Storage, Cloudflare Pages, manifest remoto, CORS dinamico para previews do projeto Pages e production fixo e smokes read-only publicados/validados. O pacote nao adiciona inimigos, combate, mapa novo, economia, backend, migrations, endpoints ou Reward Bridge. Android APK usa `debug_fallback`, aceito para playtest funcional; release signing fica adiado para distribuicao Android mais ampla. Foundation Hardening V2 segue preservado como baseline anterior de hardening/multi-mode gates no release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`; Hardening Platform V1 segue preservado como baseline anterior. Track 13 release safety e Track 14 agent ops seguem preservados. Track 21 Arena Loop Unlock/Friction e Track 20 Season 1 Arena Calibration seguem como contexto preservado do Autobattler/Arena PVE; Remote Lab Runner segue como contexto preservado de Labs no Web export.
...
- Proximo passo: playtest funcional humano do pacote Openworld QoL regression fix publicado; depois decidir polish fino do Bosque ou abrir threads dedicadas por modo a partir de `master` atualizado, mantendo tuning fino da Arena apenas apos confirmacao manual do loop tutorial -> primeira Arena real completa -> proxima dificuldade desbloqueada.
