...
- Foco P2 de implementacao: `Projetos/draxos-mobile/` (`INTEGRATED_RUNTIME_FIX_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-integrated-runtime-fix-20260602-ab5834c`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://888320f4.draxos-mobile-internal-alpha.pages.dev`, preservando Integrated App/Arena/Bosque `99304ed`, Web Launch Resilience, Refugio Visual Cleanup, Openworld QoL regression fix, Foundation Hardening V2 (`FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`) e Hardening Platform V1 como baselines anteriores, Track 21 Arena Loop Unlock/Friction como contexto do Autobattler, Track 20 Season 1 Arena Calibration, Remote Lab Runner, Track 13 release safety e Track 14 agent ops)
...
- Status: **P2_IMPLEMENTACAO - INTEGRATED_RUNTIME_FIX_PUBLISHED_INTERNAL_ALPHA**
- Fase: `Implementacao`
...
- Baseline atual: runtime fix publicado como Internal Alpha no release root `internal-alpha/v0-integrated-runtime-fix-20260602-ab5834c`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html` e deployment evidence `https://888320f4.draxos-mobile-internal-alpha.pages.dev`, mantendo o dominio fixo protegido por Cloudflare Access e usando o preview hash como evidencia tecnica publica. O pacote corrige o integrado App/Arena/Bosque: Bosque revision/event queue, mutacoes Bosque server-confirmed, envelope comum de `/modes/session/event`, metadata de replay Arena e compatibilidade ativa de `mode_limit_policies`. Supabase migration, Edge Functions, Storage upload, Cloudflare Pages e manifest remoto passaram. Smoke Chrome/CDP no preview carregou o jogo em 5838 ms, com screenshot em `build/diagnostics/web-launch-remote-20260602-223337/web-launch-remote.png`; release artifacts smoke, release manifest smoke e internal alpha remote smoke integrado com Arena/Bosque passaram; GET anonimo no production fixo retorna Cloudflare Access como esperado. Android APK usa `debug_fallback`, aceito para playtest funcional; release signing fica adiado para distribuicao Android mais ampla. Integrated App/Arena/Bosque `99304ed`, Web Launch Resilience, Refugio Visual Cleanup, Openworld QoL regression fix, Foundation Hardening V2 (`FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`) e Hardening Platform V1 seguem preservados como baselines anteriores. Track 13 release safety e Track 14 agent ops seguem preservados. Track 21 Arena Loop Unlock/Friction e Track 20 Season 1 Arena Calibration seguem como contexto preservado do Autobattler/Arena PVE; Remote Lab Runner segue como contexto preservado de Labs no Web export.
...
- Proximo passo: playtest humano do pacote integrado corrigido, cobrindo login/cache refresh, primeira Arena real, Arena replay/recompensa e Bosque online start/event/deposit/complete; depois decidir entre polish visual dedicado, tuning fino de Arena ou proximo pacote de Openworld.
