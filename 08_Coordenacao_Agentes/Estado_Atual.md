...
- Proximo passo: review/merge da branch local `codex/draxos-mobile/technical-hardening`; depois playtest humano do pacote publicado, focando coleta/deposito/resync do Bosque e menu principal simplificado antes de abrir novas expansoes.
