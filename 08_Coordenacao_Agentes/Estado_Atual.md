...
- Tech probe P2 de implementacao: `Projetos/FpsShooter/` (`FPS_PLAYGROUND_TRACK_04A_MENU_FOOTBALL_V1_COMPLETE`; PC Windows editor-first FPS Playground independente com tema Draxos leve; proximo passo: playtest humano de 5 minutos do menu, `Arena Shooter`, retorno ao menu, `Futebol`, chutes LMB/RMB, gols ate 3, bot futebol, restart, pause e sensibilidade)
...
- Status: **P2_IMPLEMENTACAO - FPS_PLAYGROUND_TRACK_04A_MENU_FOOTBALL_V1_COMPLETE**
- Fase: `Implementacao - FPS Playground Tech Probe`
- Local: `Projetos/FpsShooter/`
- Baseline atual: projeto oficial implementavel criado para testar Godot 4.6.2 em gameplay 3D primeira pessoa, PC Windows editor-first. Track 04A FPS Playground Menu & Futebol V1 completa sobre Track 03B e baselines anteriores: o projeto agora apresenta `FPS Playground` como identidade local, abre em menu principal e oferece `Arena Shooter` e `Futebol`. `Arena Shooter` preserva `Duel Pit V2` com spawns protegidos, cover, plataformas, jump pads, pickups elevados com micro-commit, rifle hitscan, RMB Plasma Bolt, feedback/HUD de combate, bot vertical-aware, rotas por jump pads, dodge de plasma, salto simples e knockback aceito, sem void/fall zones no mapa atual. `Futebol` adiciona modo em primeira pessoa 1x1 contra bot, sem armas, LMB chute, RMB chute forte, bola `RigidBody3D` arcade solta, campo festivo por primitivas, gols ate 3, bot que ataca/defende, score HUD, feedback/audio sintetico de chute/gol e retorno ao menu pelo pause.
...
- Proximo passo: playtest humano de 5 minutos do `FPS Playground`: menu inicial, `Arena Shooter` preservado, retorno ao menu, `Futebol`, LMB/RMB chute, gols ate 3, bot futebol, restart, pause, sensibilidade e retorno ao menu.
