...
- Proximo passo: testar rollback/retry/idempotencia das RPCs v1 contra Supabase live/local; depois escolher explicitamente o pacote de base builder, autobattler, social ou minigame.
