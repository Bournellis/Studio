...
- Status: **P2_IMPLEMENTACAO - internal alpha v0 remote bootstrap green**
- Fase: `Implementacao`
...
- Baseline atual: Track 00 completa com primeiro slice server-authoritative, Track 01 completa para hardening do alpha PC local e Track 02 com Progression Lab/Battle Lab v1, Character Systems Rework, Source Identity Balance v2, batalha visual procedural 2D, smokes e validacoes verdes. Track 03 tem design lock completo, T03-P02 repo-ready e T03-P11 local QA completo apos reset de cache Godot, scratch Progression Lab e Supabase local, com checks/lints Deno, smokes Supabase locais, Godot validate/GUT, smokes de app/labs e presets de export verdes. O app local cobre save ativo `normal`/`progression_lab`, reset separado, aplicacao server-backed de healthy saves no Lab, Base Manager jogavel, Social basico jogavel, Competicao/leaderboard alpha, Loja proof-of-concept e Batalha com readout compacto/HP percentual/tooltips melhores. T03-P12 release prep esta completo: ordem T03-P12 a T03-P18 documentada, portal base criado em `Projetos/draxos-mobile/portal/internal-alpha/`, tutorial Supabase remoto criado e projeto remoto observado `armxgipvnbbshzqawklw`. T03-P13 remoto bootstrap esta completo: Supabase CLI linkado, migrations aplicadas, Edge Functions publicadas e smoke remoto minimo verde. Supabase segue para alpha, Backend Proprio + Postgres e o plano de saida preferido, e Nakama fica apenas se realtime/social competitivo virar pilar. A build mira app hibrido idle/manager + hub RPG, Android paisagem, PC/Web amplo, email/senha, username, dois saves por conta, Lab marcado em vermelho no social/chat e fora da competicao, Base/Social/Competicao/Loja jogaveis, leaderboard sem bots, redeems diarios em Diamante e manifest remoto de updates para Android/PC/Web.
...
- Proximo passo: executar T03-P14 auth email/senha e alpha gate no Godot/backend remoto.
