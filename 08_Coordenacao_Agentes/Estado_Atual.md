...
- Status: **P2_IMPLEMENTACAO - internal alpha v0 release prep**
- Fase: `Implementacao`
...
- Proximo passo: Fabio seguir o tutorial Supabase remoto, criar `.env.internal-alpha.local` ignorado e confirmar os valores publicos do projeto `armxgipvnbbshzqawklw`; depois executar T03-P13 Supabase remoto.
