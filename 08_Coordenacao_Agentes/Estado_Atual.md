...
- Foco P2 de implementacao: `Projetos/draxos-mobile/` (`BOSQUE_V3_UX_FEEL_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-bosque-v3-ux-feel-20260605-782dc45`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://dcf6eb15.draxos-mobile-internal-alpha.pages.dev`, publicando polimento estreito do Bosque com spawn/colisao mais seguros, feedback de coleta/deposito/craft, fogueira/landmarks e resumo de visita; preserva Technical Hardening `internal-alpha/v0-technical-hardening-20260605-8e54a1f` como pacote tecnico anterior, Openworld Main Menu Sync `internal-alpha/v0-openworld-main-menu-sync-20260604-bc36cd8` como pacote de conteudo anterior, Bosque Mecanico Basico v2, First Access Runtime Fix, Foundation Hardening V2 (`FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`) e Hardening Platform V1 como baselines anteriores, Track 21 Arena Loop Unlock/Friction como contexto do Autobattler, Track 20 Season 1 Arena Calibration, Remote Lab Runner, Track 13 release safety e Track 14 agent ops)
...
- Baseline atual: Bosque v3 UX/Feel publicado como Internal Alpha no release root `internal-alpha/v0-bosque-v3-ux-feel-20260605-782dc45`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html` e deployment evidence `https://dcf6eb15.draxos-mobile-internal-alpha.pages.dev`, mantendo o dominio production como URL oficial e o hash como evidencia tecnica. O pacote publica polimento estreito do Bosque: resource node fora de bloqueadores, colisao de arvores/pedras levemente reduzida, feedback visual/textual de proximidade/coleta/deposito/craft, fogueira glow, landmarks nao bloqueantes e resumo de visita player-facing. Export, Storage upload publico, Cloudflare Pages branch `main`, manifest remoto, RemoteReadOnly e smoke Web no preview passaram; stable Portal/Web ficam Cloudflare Access protected. Android APK usa `debug_fallback`, aceito para playtest funcional; release signing fica adiado para distribuicao Android mais ampla. Technical Hardening (`internal-alpha/v0-technical-hardening-20260605-8e54a1f`, preview `https://2fe9393e.draxos-mobile-internal-alpha.pages.dev`) segue preservado como pacote tecnico anterior; Openworld Main Menu Sync (`internal-alpha/v0-openworld-main-menu-sync-20260604-bc36cd8`, preview `https://aeec7403.draxos-mobile-internal-alpha.pages.dev`) segue preservado como pacote de conteudo anterior com Bosque/menu; Bosque Mecanico Basico v2, First Access Runtime Fix, Foundation Hardening V2 (`FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`) e Hardening Platform V1 seguem preservados como baselines anteriores. Track 13 release safety e Track 14 agent ops seguem preservados. Track 21 Arena Loop Unlock/Friction e Track 20 Season 1 Arena Calibration seguem como contexto preservado do Autobattler/Arena PVE; Remote Lab Runner segue como contexto preservado de Labs no Web export.
...
- Proximo passo: playtest humano do pacote Bosque v3 UX/Feel publicado, focando coleta/deposito/resync do Bosque, leitura de proximidade/deposito/craft, menu principal simplificado, tutorial Arena e regressao tecnica antes de abrir novas expansoes.
