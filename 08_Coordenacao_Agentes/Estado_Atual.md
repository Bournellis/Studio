...
- Foco P2 de implementacao: `Projetos/draxos-mobile/` (`BOSQUE_MECANICO_BASICO_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-bosque-v2-guidance-20260604-7c2d981`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://ae049df9.draxos-mobile-internal-alpha.pages.dev`, preservando First Access Runtime Fix `4608977`, Integrated Runtime Fix `ab5834c`, Integrated App/Arena/Bosque `99304ed`, Web Launch Resilience, Refugio Visual Cleanup, Openworld QoL regression fix, Foundation Hardening V2 (`FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`) e Hardening Platform V1 como baselines anteriores, Track 21 Arena Loop Unlock/Friction como contexto do Autobattler, Track 20 Season 1 Arena Calibration, Remote Lab Runner, Track 13 release safety e Track 14 agent ops)
...
- Proximo passo: playtest humano do pacote publicado Bosque Mecanico Basico v2 (free entry/exit, guidance, coleta/deposito/craft, `Voltar`, `Encerrar visita`, persistencia e fogueira).
