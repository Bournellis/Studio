...
- Proximo passo: publicar o hotfix local da Arena Duel Flow na URL oficial se aprovado; depois retomar playtest humano do pacote Arena PVE focando tutorial -> primeira arena real de 3 duelos, buff entre duelos, retomar/abandonar/encerrar tentativa antiga, Preparacao no menu ativo e regressao Bosque/menu antes de abrir tuning amplo ou novas expansoes.
