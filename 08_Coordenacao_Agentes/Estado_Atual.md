...
- Proximo passo: decidir entre Card Impact V2 para capturar deltas de efeito/log em cartas de jogador ou um lote maior controlado de cartas usando o mesmo fluxo before -> alteracao -> after -> compare; depois retomar playtest de usuario da Track 02 completa.
