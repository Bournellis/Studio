...
- Baseline addendum: Card Impact V3 Isolated Target Capture disponivel em `track02_card_impact_v3`, com `card_focus_isolated`, captura da carta alvo uma vez, parada apos alvo, `capture_quality`, gate estrutural para captura repetida/falha, 84/84 cartas ativas cobertas, 45 player captures clean, 9 support-required, 0 ambiguous, 0 failed e 0 repeated. Validacao verde em 2026-06-05 com V3 before/after/compare, Battle Lab, Scenario Fixtures, AutoRun smoke/quick e `validate.gd` 164/164.
...
- Proximo passo: usar Card Impact V3 como harness padrao no proximo redesign amplo de cartas de jogador; assinaturas de cartas inimigas seguem como follow-up tecnico. Track 02 segue pronta para playtest de usuario da rota completa.
