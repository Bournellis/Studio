...
- Foco operacional ativo: `Projetos/JogoDaCopa/` (`Super Campeao v1.2.1+ff9cb389` publicado; aguardando retest humano) + `Projetos/draxos-mobile/` (candidato local Arena UX/readability/recovery validado; aguardando prova humana)
