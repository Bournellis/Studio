...
- Foco operacional ativo: `Projetos/JogoDaCopa/` (09P publicada com gates remotos PASS; aguardando reteste humano; 09N segue fallback aprovado) + `Projetos/draxos-mobile/` (Arena Runtime Config Sync Ready v3 publicado Web/APK/PC; aguardando prova humana) + `Projetos/FpsPlayground/` (Track 11 complete telemetry implementada localmente; movimento atual preservado)
