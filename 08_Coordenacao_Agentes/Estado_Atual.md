...
- Proximo passo: executar playtest alpha PC local usando `Projetos/draxos-mobile/docs/playtest-alpha.md` e usar Battle Lab runs para proxima rodada fina de `pet_handler`, `dot_pressure` e pesos de poder.
