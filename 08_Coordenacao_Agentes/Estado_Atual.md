...
- Foco P2 de implementacao: `Projetos/draxos-mobile/` (`BOSQUE_FOGUEIRA_POTION_CRAFTING_V1_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-bosque-fogueira-potion-crafting-v1-20260606-cad6d2c`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://08d00f24.draxos-mobile-internal-alpha.pages.dev`, publicado em `main`, forcando APK/manifest `0.0.7-alpha.0`/version code `7` e transformando `Fogueira Estavel I` em estacao server-authoritative para pocoes globais; preserva Bosque Durable Bau Mochila v1 como pacote duravel anterior (`internal-alpha/v0-bosque-durable-bau-mochila-v1-20260606-6e7ca6b`, preview `https://39198a35.draxos-mobile-internal-alpha.pages.dev`), Arena PVE Menu Flow Simplification v1 como pacote anterior de Arena (`internal-alpha/v0-arena-pve-menu-flow-simplification-v1-20260606-5d03a68`, preview `https://fdf44707.draxos-mobile-internal-alpha.pages.dev`), Bosque Offline-First Checkpoint v1 como politica runtime anterior (`internal-alpha/v0-bosque-offline-first-checkpoint-v1-20260606-f649d22`, preview `https://fa84e109.draxos-mobile-internal-alpha.pages.dev`), Bosque Sync Responsiveness v1, Arena/Bosque Visible V2, Arena/Bosque Regression Hotfix, Arena PVE Season 1 Loop v1, Arena Duel Flow Hotfix, Arena PVE First Real Run + Update Recovery, Bosque v3 UX/Feel, Technical Hardening, Openworld Main Menu Sync, `FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, Track 23 Arena recovery, Track 21 Arena Loop Unlock/Friction, Track 20 Season 1 Arena Calibration, Remote Lab Runner, Track 13 release safety e Track 14 agent ops)
...
- Proximo passo: playtest manual da Track 02 completa antes de novo tuning.
...
- Baseline atual: Bosque Fogueira Potion Crafting v1 publicado como Internal Alpha no release root `internal-alpha/v0-bosque-fogueira-potion-crafting-v1-20260606-cad6d2c`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html` e deployment evidence `https://08d00f24.draxos-mobile-internal-alpha.pages.dev`. O pacote forca APK/manifest `0.0.7-alpha.0`/version code `7`, publica Web/APK novos, aplica migration remota `202606060003_bosque_fogueira_potion_crafting_v1.sql`, transforma `Fogueira Estavel I` em estacao server-authoritative para `pocao_vida`, `pocao_foco` e `pocao_resguardo`, consome materiais do `Bau` + `po_osso`, e preserva runtime local/offline-first com progresso duravel e reward server-authoritative. Bosque Durable Bau Mochila v1 (`internal-alpha/v0-bosque-durable-bau-mochila-v1-20260606-6e7ca6b`, preview `https://39198a35.draxos-mobile-internal-alpha.pages.dev`) segue preservado como pacote duravel anterior; Arena PVE Menu Flow Simplification v1 (`internal-alpha/v0-arena-pve-menu-flow-simplification-v1-20260606-5d03a68`, preview `https://fdf44707.draxos-mobile-internal-alpha.pages.dev`) segue preservado como pacote anterior de Arena; Bosque Offline-First Checkpoint v1 (`internal-alpha/v0-bosque-offline-first-checkpoint-v1-20260606-f649d22`, preview `https://fa84e109.draxos-mobile-internal-alpha.pages.dev`) segue preservado como politica runtime anterior do Openworld; Bosque Sync Responsiveness v1, Arena/Bosque Visible V2, Arena/Bosque Regression Hotfix, Arena PVE Season 1 Loop v1, Arena Duel Flow Hotfix, Arena PVE First Real Run + Update Recovery, Bosque v3 UX/Feel, Technical Hardening, Openworld Main Menu Sync e `FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA` seguem preservados como baselines anteriores. Export, Storage upload publico, Cloudflare Pages branch `main`, manifest remoto, deploy das Edge Functions `crafting`/`build`/`arena`/`battle`/`content`/`monetization`/`release`, smoke Web no preview e smokes remotos read-only passaram; stable Portal/Web ficam Cloudflare Access protected. Android APK usa `debug_fallback`, aceito para playtest funcional; release signing fica adiado para distribuicao Android mais ampla.
...
- Proximo passo: playtest humano do pacote Bosque Fogueira Potion Crafting v1 a partir de `main`; validar Fogueira station craft, checkpoint-before-craft, tres pocoes simples, equip/uso na Arena e persistencia de `Bau`/`Mochila/Bolso` apos sair/reabrir, completar visita, atualizar APK/Web e reentrar. Manter regressao de Arena PVE Menu Flow Simplification v1 e nao reabrir microeventos revisionados como loop normal do Bosque sem nova decisao.
