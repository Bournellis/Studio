...
- Proximo passo: playtest humano do pacote publicado Bosque Offline-First Checkpoint v1, focando entrada sem transformacao visivel, coletar 10+ recursos rapidamente sem reiniciar acao, depositar/craftar enquanto checkpoint salva, voltar/reabrir preservando bolso/bau/nodes, encerrar com reward apenas apos checkpoint aceito, alem das regressoes de Arena Preparacao e buff -> Resolver duelo.
