...
- Proximo passo: executar playtest alpha PC local usando `Projetos/draxos-mobile/docs/playtest-alpha.md` e observar dominancia de `burst_caster`/`pet_handler` antes da proxima rodada de tuning.
