...
- Foco P2 de implementacao: `Projetos/draxos-mobile/` (`BOSQUE_RESUME_EXIT_LIFECYCLE_V1_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-bosque-resume-exit-lifecycle-v1-20260608-9a0f7c0`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://39128c59.draxos-mobile-internal-alpha.pages.dev`, publicado Web/APK, APK/manifest `0.0.12-alpha.0`/version code `12`; Bosque preserva checkpoint operations ACK-backed e feel local, e corrige `Voltar -> reabrir -> sair` retomando sessao viva sem Bosque novo fora do save nem trap de saida)
...
- Status: **P2_IMPLEMENTACAO - BOSQUE_RESUME_EXIT_LIFECYCLE_V1_PUBLISHED_INTERNAL_ALPHA**
- Fase: `Implementacao`
...
- Baseline atual: Bosque Resume Exit Lifecycle v1 publicado como Internal Alpha no release root `internal-alpha/v0-bosque-resume-exit-lifecycle-v1-20260608-9a0f7c0`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html` e deployment evidence `https://39128c59.draxos-mobile-internal-alpha.pages.dev`. O pacote forca APK/manifest `0.0.12-alpha.0`/version code `12`, publica Web/APK novos, preserva checkpoint `operations` com ACK e o feel local do pacote anterior, e corrige o lifecycle `Voltar -> reabrir Bosque -> sair`: sessao viva preservada e retomada em vez de Bosque novo fora do save, conflito de start devolve a sessao ativa existente, e checkpoint falho na saida preserva pendencias sem prender o jogador. Bosque Feel & Spawn Authority v1 segue preservado como pacote anterior de feel/spawn; Bosque Persistence Rebase v1 segue preservado como pacote anterior de persistencia/operacoes com migrations remotas `202606080001_openworld_bosque_persistence_rebase_v1.sql` e `202606080002_openworld_bosque_jsonb_object_length_hotfix_v1.sql`; Bosque Session Lifecycle & Durable Structures Hotfix v1 segue preservado como pacote anterior; Bosque World Hub Domain Separation v1, Bosque Fogueira Potion Crafting v1, Bosque Durable Bau Mochila v1, Arena PVE Menu Flow Simplification v1 e Bosque Offline-First Checkpoint v1 seguem preservados como baselines anteriores.
