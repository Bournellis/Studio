...
- Marker: `JOGO_DA_COPA_TRACK_04B1_CHARACTER_PRESENTATION_V1_WORKTREE_VERIFIED`
- Baseline: `Copa Arena Futebol`, 1x1 vs bot TPS, arena noturna de vidro estanque ate o teto, gols com painel frontal alto, personagem real skinned/audio real, bola com CCD/trail/fireball/squash, dash/slide/stun/flip, chute carregado/SUPER sem gasto em whiff, boost/jump pads, timer 3min default com golden goal/vale-2, HUD/menu arcade com clique real, bot defensivo/aereo, camera/reset de kickoff protegidos, avatar real com facing visual, uniforme procedural por regioes, cabelo real anexado ao Head, toon sem duplicata T-pose e chute 04B1 verificado na worktree. Detalhes em `Projetos/JogoDaCopa/implementation/current-status.md`.
- Trabalho permitido: codigo, design, validacao, playtest no editor e documentacao local.
- Proximo passo: review da Claude na branch `codex/jogodacopa/track04b1-character-presentation-v1`; nao mergear em main antes da aprovacao.
