...
- Foco P2 de implementacao: `Projetos/draxos-mobile/` (`BOSQUE_DIEGETIC_LAUNCHER_FOUNDATION_V1_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-bosque-diegetic-launcher-foundation-v1-20260609-e55ed0c`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://56b58162.draxos-mobile-internal-alpha.pages.dev`, publicado Web/APK, APK/manifest `0.0.16-alpha.0`/version code `16`; Bosque vira launcher diegetico e preserva autoridade de bootstrap antes de renderizar o viewport jogavel, mantem minimum supported version code `13`, proximo passo operacional: playtest humano focado do pacote publicado)
...
- Baseline atual: Bosque Diegetic Launcher Foundation v1 publicado como Internal Alpha no release root `internal-alpha/v0-bosque-diegetic-launcher-foundation-v1-20260609-e55ed0c`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html` e deployment evidence `https://56b58162.draxos-mobile-internal-alpha.pages.dev`. O pacote publica Web/APK `0.0.16-alpha.0`/version code `16`, mantem minimum supported version code `13`, redeploya `release`, transforma o Bosque em launcher diegetico para Arena/Base/Shop/Social/Profile e preserva o guard que impede o Bosque integrado de renderizar um mundo jogavel full-spawn antes do bootstrap canonico remoto/cache. Bosque Bootstrap Authority v1 segue preservado como pacote bootstrap anterior; Arena PVE Bonus Visual v1 segue preservado como pacote Arena anterior; Bosque Node Cooldown ACK v1 segue preservado como pacote Bosque anterior; Bosque Resume Exit Lifecycle v1, Bosque Feel & Spawn Authority v1 e Bosque Persistence Rebase v1 seguem preservados como baselines anteriores com migrations remotas `202606080001_openworld_bosque_persistence_rebase_v1.sql` e `202606080002_openworld_bosque_jsonb_object_length_hotfix_v1.sql`.
...
- Proximo passo: playtest humano focado do `Bosque Diegetic Launcher Foundation v1` publicado em Web/APK, validando prompts/landmarks do Bosque, abertura de Arena/Base/Shop/Social/Profile e retorno via `Voltar`. Bugs futuros voltam ao fluxo normal se aparecerem. Nao abrir tuning amplo, PVP, economia, conteudo, novas armas/spells, visual final ou mutacoes remotas sem decisao propria.
