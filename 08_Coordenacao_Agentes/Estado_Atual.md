...
- Baseline: `Copa Arena Futebol`, 1x1 vs bot em terceira pessoa, arena noturna de vidro, personagem real skinned, audio real, bola com trail/fireball/squash, dash/slide/stun/flip, chute carregado/SUPER, boost/jump pads/rampas, timer 3min default com golden goal/vale-2, modo `3 gols` preservado, HUD/menu arcade e toon toggle OFF. Detalhes em `Projetos/JogoDaCopa/implementation/current-status.md`.
- Trabalho permitido: codigo, design, validacao, playtest no editor e documentacao local.
- Proximo passo: playtest humano completo - visual arcade + personagem real + audio real.
