...
- Status: **P2_IMPLEMENTACAO - source identity balance v2 + dev lab flow/visual hardened + battle stage 2d continuous cooldowns**
- Fase: `Implementacao`
