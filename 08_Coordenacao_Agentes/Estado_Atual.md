...
- Foco P2 de implementacao: `Projetos/draxos-mobile/` (`INTEGRATED_APP_ARENA_BOSQUE_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-integrated-app-arena-bosque-20260602-99304ed`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://8f2829c0.draxos-mobile-internal-alpha.pages.dev`, manifest hotfix `released_at=2026-06-02T20:53:32Z`, preservando Web Launch Resilience, Refugio Visual Cleanup, Openworld QoL regression fix, Foundation Hardening V2 (`FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`) e Hardening Platform V1 como baselines anteriores, Track 21 Arena Loop Unlock/Friction como contexto do Autobattler, Track 20 Season 1 Arena Calibration, Remote Lab Runner, Track 13 release safety e Track 14 agent ops)
