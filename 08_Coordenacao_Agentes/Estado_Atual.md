...
- Proximo passo: playtest humano do pacote first access runtime, cobrindo login/no-cache refresh, primeira Arena real, Arena replay/recompensa e Bosque online start/event/deposit/complete; depois decidir entre polish visual dedicado, tuning fino de Arena ou proximo pacote de Openworld.
