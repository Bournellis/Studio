...
- Foco P2 de implementacao: `Projetos/draxos-mobile/` (`TECHNICAL_HARDENING_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-technical-hardening-20260605-8e54a1f`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://2fe9393e.draxos-mobile-internal-alpha.pages.dev`, publicando Track 22 Technical Hardening, preservando Openworld Main Menu Sync `internal-alpha/v0-openworld-main-menu-sync-20260604-bc36cd8` como pacote de conteudo anterior, Bosque Mecanico Basico v2 `internal-alpha/v0-bosque-v2-guidance-20260604-7c2d981`, First Access Runtime Fix `4608977`, Integrated Runtime Fix `ab5834c`, Integrated App/Arena/Bosque `99304ed`, Web Launch Resilience, Refugio Visual Cleanup, Openworld QoL regression fix, Foundation Hardening V2 (`FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`) e Hardening Platform V1 como baselines anteriores, Track 21 Arena Loop Unlock/Friction como contexto do Autobattler, Track 20 Season 1 Arena Calibration, Remote Lab Runner, Track 13 release safety e Track 14 agent ops)
...
- Status: **P2_IMPLEMENTACAO - TECHNICAL_HARDENING_PUBLISHED_INTERNAL_ALPHA**
- Fase: `Implementacao`
...
- Baseline atual: Technical Hardening publicado como Internal Alpha no release root `internal-alpha/v0-technical-hardening-20260605-8e54a1f`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html` e deployment evidence `https://2fe9393e.draxos-mobile-internal-alpha.pages.dev`, mantendo o dominio production como URL oficial e o hash como evidencia tecnica. O pacote publica Track 22: aplica remotamente `202606050001_arena_reward_profiles_v1.sql` e `202606050002_account_reset_request_hash_v1.sql`, redeploya Edge Functions, migra endpoints mutaveis/lab/release para auth compartilhado, promove reset com `request_hash`, move Arena rewards para perfis DB-side, remove `Modes Ops` do cliente e reduz hotspots com helpers extract-only. `FullLocal`, `RemoteReadOnly`, export, Storage upload publico, Cloudflare Pages branch `main`, manifest remoto e smoke Web no preview passaram; stable Portal/Web ficam Cloudflare Access protected. Android APK usa `debug_fallback`, aceito para playtest funcional; release signing fica adiado para distribuicao Android mais ampla. Openworld Main Menu Sync (`internal-alpha/v0-openworld-main-menu-sync-20260604-bc36cd8`, preview `https://aeec7403.draxos-mobile-internal-alpha.pages.dev`) segue preservado como pacote de conteudo anterior com Bosque/menu; Bosque Mecanico Basico v2, First Access Runtime Fix `4608977`, Integrated Runtime Fix `ab5834c`, Integrated App/Arena/Bosque `99304ed`, Web Launch Resilience, Refugio Visual Cleanup, Openworld QoL regression fix, Foundation Hardening V2 (`FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`) e Hardening Platform V1 seguem preservados como baselines anteriores. Track 13 release safety e Track 14 agent ops seguem preservados. Track 21 Arena Loop Unlock/Friction e Track 20 Season 1 Arena Calibration seguem como contexto preservado do Autobattler/Arena PVE; Remote Lab Runner segue como contexto preservado de Labs no Web export.
...
- Proximo passo: playtest humano do pacote Technical Hardening publicado, focando coleta/deposito/resync do Bosque, menu principal simplificado, tutorial Arena e regressao tecnica antes de abrir novas expansoes.
