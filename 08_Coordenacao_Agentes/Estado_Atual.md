...
- Tech probe P2 de implementacao: `Projetos/FpsShooter/` (`FPS_SHOOTER_TRACK_01D_KNOCKBACK_MOVEMENT_COMBAT_COMPLETE`; PC Windows editor-first FPS 3D independente com tema Draxos leve; proximo passo: playtest humano de 3-5 minutos focado em knockback aplicado/recebido, rampas/plataformas do `Duel Pit V1` e selecao do proximo foco da Track 01)
...
- Proximo passo: playtest humano de 3-5 minutos do `Duel Pit V1` focado em knockback aplicado/recebido, rampas/plataformas e controle de duelo; depois selecionar o proximo foco da Track 01: futuras variantes de arma/projetil ou primeira expansao de hazard/verticalidade.
