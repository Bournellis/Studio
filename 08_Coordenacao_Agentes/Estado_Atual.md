...
- Status: **P2_IMPLEMENTACAO - character systems rework implemented**
- Fase: `Implementacao`
...
- Proximo passo: rodar Progression Lab com Supabase local, carregar saves `2h`-`20h` manualmente no Godot e abrir rodada before/after de tuning pos-rework: anti-stall, dominancia, poder, recompensa e bots.
