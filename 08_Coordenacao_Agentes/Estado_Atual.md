...
- Tech probe P2 de implementacao: `Projetos/FpsShooter/` (`FPS_PLAYGROUND_TRACK_04A_FOOTBALL_FIRST_FIXES_COMPLETE`; PC Windows editor-first FPS Playground independente com tema Draxos leve; proximo passo: playtest humano de 5 minutos do menu centralizado, `Arena Shooter`, retorno ao menu, `Futebol`, `Como Jogar`/`Começar`, chutes LMB/RMB, gols sem buraco/queda, gols ate 3, bot futebol, restart, pause e sensibilidade)
...
- Proximo passo: playtest humano de 5 minutos do `FPS Playground`: menu inicial centralizado, `Arena Shooter` preservado, retorno ao menu, `Futebol`, `Como Jogar`/`Começar`, LMB/RMB chute, confirmar que os gols nao tem buraco/queda, gols ate 3, bot futebol, restart, pause, sensibilidade e retorno ao menu.
