...
- Proximo passo: rodar smokes HTTP locais das Edge Functions sobre os adapters RPC v1 e continuar split de servicos de dominio; depois escolher explicitamente o pacote de base builder, autobattler, social ou minigame.
