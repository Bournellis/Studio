...
- Status: **P2_IMPLEMENTACAO - internal alpha v0 social basic playable ready**
- Fase: `Implementacao`
...
- Proximo passo: executar `T03-P07 - Competicao e Leaderboards`; Supabase remoto e builds ficam adiados ate o gameplay local estar pronto.
