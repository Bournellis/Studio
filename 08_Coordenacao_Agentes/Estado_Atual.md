...
- Status: **P2_IMPLEMENTACAO - internal alpha v0 local automated QA green**
- Fase: `Implementacao`
...
- Proximo passo: passada manual no Godot/editor para UX/legibilidade real usando o checklist interno; Supabase remoto e builds ficam adiados ate o gameplay local estar aprovado para compartilhar.
