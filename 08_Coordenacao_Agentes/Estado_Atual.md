...
- Foco operacional temporario unico: `Projetos/JogoDaCopa/` (`JOGO_DA_COPA_BALL_GOAL_KICK_TUNING_V1_COMPLETE`; PC Windows editor-first futebol/minigames independente; proximo passo: playtest humano do Futebol com tuning de bola/gol/chute e planejamento da proxima track)
...
- Proximo passo: foco imediato do estudio em playtest humano do `Futebol` com tuning de bola/gol/chute e escolha da proxima track de gameplay.
