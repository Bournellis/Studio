...
Continuar a reducao do `FootballRoot` com uma extracao estreita do fluxo de partida/kickoff/reset/countdown, preservando gameplay, input, fisica, bot, scoring, assets e comportamento publico.

## Arquivos Pretendidos

- `Projetos/JogoDaCopa/modes/football/football_root.gd`
- `Projetos/JogoDaCopa/modes/football/football_match_flow_controller.gd`
- Testes focados em `Projetos/JogoDaCopa/tests/`, se a migracao exigir nova cobertura ou ajuste de contrato.
...
- Chrome boot local com screenshot/evidencia em `docs/playtest-reports/track-09d-data/`.
...
- `tools/validate.gd` PASS: `104` testes, `1826` asserts, `52` fontes.
- Web export release PASS.
- Validate com build Web presente PASS: gzip `30.60 MiB / 50.00 MiB`.
