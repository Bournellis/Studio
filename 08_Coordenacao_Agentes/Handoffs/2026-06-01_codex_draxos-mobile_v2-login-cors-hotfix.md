...
- Reexportar Android/PC/Web e republicar em release root cache-bust
...
- Edge Functions redeployadas com CORS para
  `https://ca946749.draxos-mobile-internal-alpha.pages.dev`.
- Android/PC/Web reexportados; Android saiu em `debug_fallback` porque a keystore
  release nao estava disponivel neste worktree de correcao.
...
- `tools/export_internal_alpha.ps1 -ProjectDir . -AllowAndroidDebugFallback`: PASS,
  Android `debug_fallback`.
...
- `wrangler pages deploy`: PASS, preview `ca946749`.
