...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 local automated QA green | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Passada manual no Godot/editor para UX/legibilidade real | iOS sem pedido explicito; mobile browser fora do escopo; remoto/builds adiados ate gameplay local aprovado; secrets e service role nunca entram no cliente/export |
