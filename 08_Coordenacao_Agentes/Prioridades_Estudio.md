...
- Foco operacional ativo: `Projetos/JogoDaCopa/` (10D publicada com gates remotos PASS; aguardando reteste humano; 10A fallback aprovado) + `Projetos/draxos-mobile/` (hardening integrado localmente preservado; Arena Runtime Config Sync Ready v3 publicado Web/APK/PC; aguardando prova humana) + `Projetos/FpsPlayground/` (Track 14I limpeza de debugger Godot mergeada localmente; movimento atual preservado)
