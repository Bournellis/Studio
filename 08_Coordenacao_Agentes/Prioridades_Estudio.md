...
- Foco P2 de implementacao (Track 10 `INTEGRATED_BATTLE_PRESENTATION_READY`): `Projetos/draxos-mobile/`
...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Track 10 `INTEGRATED_BATTLE_PRESENTATION_READY` | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Fazer walkthrough visual/manual de Refugio -> Batalha -> Summary -> Logs no Godot/Android | iOS sem pedido explicito; mobile browser fora do escopo primario; secrets e service role nunca entram no cliente/export; migration conta/save fora do pacote atual; referencias em `assets/referenciaimagens/` sao moodboard, nao runtime assets |
