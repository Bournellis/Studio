...
- Foco operacional ativo: `Projetos/JogoDaCopa/` (09P validada localmente; publico aprovado segue `Super Campeao v1.2.1+5c6520ba` / 09N) + `Projetos/draxos-mobile/` (hardening integrado localmente preservado; Arena Runtime Config Sync Ready v3 publicado Web/APK/PC; aguardando prova humana) + `Projetos/FpsPlayground/` (Track 11 complete telemetry implementada localmente; movimento atual preservado)
