...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 downloads e Portal/Web publicados | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Signoff manual Fabio + tester antes de T03-P18 | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
