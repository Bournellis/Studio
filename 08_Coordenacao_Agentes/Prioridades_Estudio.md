...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Source Identity Balance v2 + Godot Lab Runners Hardened | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Rodar Progression Lab com Supabase local, testar saves 2h-20h manualmente no Godot e abrir rodada before/after focada em premium gap 10h, janelas 15h/20h, poder, recompensa, Defesa/Mental e sensacao de Familiar/Funeral | iOS sem pedido explicito; mobile browser fora do escopo |
