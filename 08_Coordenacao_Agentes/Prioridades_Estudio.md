...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Bootstrap | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Continuar T00-P10 - DoTs/status/resistencias, smoke FIRST_SLICE_SIM e replay rico | iOS sem pedido explicito; mobile browser fora do escopo |
