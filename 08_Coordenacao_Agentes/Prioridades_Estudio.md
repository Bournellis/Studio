...
Nota DraxosMobile: `Arena PVE Season 1 Loop v1` foi publicado como Internal Alpha em `internal-alpha/v0-arena-pve-season1-loop-v1-20260605-c8baf32`, mantendo a URL principal como contrato player-facing e usando `main` como trunk local/publicacao Pages. `Arena Duel Flow Hotfix` segue preservado como hotfix anterior e `Arena PVE First Real Run + Update Recovery` segue preservado como baseline Arena anterior.
