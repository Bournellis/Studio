...
- Foco operacional ativo: `Projetos/JogoDaCopa/` (09S publicada e aprovada; 09Q fallback aprovado) + `Projetos/draxos-mobile/` (hardening integrado localmente preservado; Arena Runtime Config Sync Ready v3 publicado Web/APK/PC; aguardando prova humana) + `Projetos/FpsPlayground/` (Track 14F mergeada localmente; movimento atual preservado)
