...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Alpha Hardening Complete + Combat Tuning v02 + Battle Lab Dev | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Executar playtest alpha PC local e usar Battle Lab Dev/runs para proxima rodada fina de pet/poder/DoT | iOS sem pedido explicito; mobile browser fora do escopo |
