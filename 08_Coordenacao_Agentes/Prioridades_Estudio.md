...
- Foco P2 de implementacao (`FOUNDATION_AUDIT_ACTIVE`, sobre Track 13 release safety, Track 14 agent ops, Track 15 UX e ultimo pacote tecnico Track 16 local): `Projetos/draxos-mobile/`
...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - `FOUNDATION_AUDIT_ACTIVE` | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Revisar `docs/foundation-loop-audit.md` e executar um Foundation Loop UX Pass focado em Refugio como home do loop, CTA confiavel, coleta/evolucao visiveis, recompensa de batalha retornando para base e smoke sem rede do loop | iOS sem pedido explicito; mobile browser fora do escopo primario; secrets e service role nunca entram no cliente/export; publicacao remota exige `-ConfirmRemoteMutation`; migration conta/save estrutural fora do pacote atual; tuning numerico, armas, spells, economia, visual final e apresentacao de batalha bloqueados ate decisao explicita |
