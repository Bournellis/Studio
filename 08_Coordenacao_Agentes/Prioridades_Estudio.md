...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 handoff completo | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Rodada fechada Fabio + tester e backlog de feedback pos-handoff | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
