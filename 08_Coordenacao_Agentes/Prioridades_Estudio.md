...
- Tech probe P2 de implementacao (`FPS_SHOOTER_BOOTSTRAP_ACTIVE`): `Projetos/FpsShooter/`
...
| P2 | FpsShooter | `Projetos/FpsShooter/` | Implementacao - `FPS_SHOOTER_BOOTSTRAP_ACTIVE` | `P2_IMPLEMENTACAO` | Codigo, validacao, playtest no editor e documentacao local | Editor playtest do bootstrap e evolucao para Track 01 - Arena 1x1 V1: FPS tradicional, jogador contra bot simples, hitscan, HUD, knockback inicial e mapa simples | Tech probe independente com tema Draxos leve. PC Windows editor-first apenas; sem export/Web/mobile, multiplayer, matchmaking, backend, economia, progressao canonica Draxos, Ricochet, jump pads, plataformas suspensas ou void/queda ate tracks explicitas |
...
Nota FpsShooter: criado em 2026-06-09 como tech probe independente para testar Godot 4.6.2 em FPS 3D primeira pessoa. O primeiro contrato e PC Windows editor-first, FPS tradicional, arena simples 1x1 contra bot V1 que anda e atira, HUD basico e knockback inicial. Tema Draxos permitido apenas como visual leve; nao herda sistemas de DraxosMobile, Draxos Roguelike Cardgame, RPG Isometrico ou RPG Turnos.
