...
- Foco P2 de implementacao (`BOSQUE_BOOTSTRAP_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-bosque-bootstrap-authority-v1-20260609-ba99e70`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://0123894f.draxos-mobile-internal-alpha.pages.dev`; publicado em Web/APK, APK/manifest `0.0.15-alpha.0`/version code `15`, minimum supported version code `13`, playtest humano inicial reportado OK por Fabio em 2026-06-09, foco imediato em corrigir drift documental; Arena PVE Bonus Visual v1 preservado como pacote Arena anterior; Bosque Node Cooldown ACK v1 preservado como pacote Bosque anterior, seguido por Bosque Resume Exit Lifecycle v1, Bosque Feel & Spawn Authority v1, Bosque Persistence Rebase v1, Bosque Session Lifecycle & Durable Structures Hotfix v1, Bosque World Hub Domain Separation v1, Bosque Fogueira Potion Crafting v1, Bosque Durable Bau Mochila v1 e Arena PVE Menu Flow Simplification v1): `Projetos/draxos-mobile/`
