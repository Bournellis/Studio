...
- Foco P2 de implementacao (`BATTLE_PREPARATION_COMPLETE_V1_PUBLISHED`, sobre Battle Preparation v1, Battle Drama v1.1, Battle Presentation v1, Ossos Inteiros v1 publicado, Visual Direction v1, Social Guilda v1, Foundation baseline confirmada, Track 13 release safety, Track 14 agent ops, Track 15 UX e Track 16 tecnico): `Projetos/draxos-mobile/`
...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - `BATTLE_PREPARATION_COMPLETE_V1_PUBLISHED` | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Revisar Battle Preparation Complete v1 com hotfix de feedback do `Equipar` em Android/Windows/Web e escolher o proximo pacote | iOS sem pedido explicito; mobile browser fora do escopo primario; secrets e service role nunca entram no cliente/export; publicacao remota exige `-ConfirmRemoteMutation`; deploy de override do release manifest exige `SUPABASE_ACCESS_TOKEN`; mudancas visuais em Entry/Refugio/Batalha exigem `foundation-responsive-layout-contract.md` + `smoke_responsive_layout.gd`; migration conta/save estrutural fora do pacote atual; direct chat, ajudas, contribuicoes, moderacao, tuning numerico, novas armas, novas spells, economia, previsao de vitoria, contra-escolha por oponente, thresholds customizados, comportamento por inimigo e controles avancados de replay bloqueados ate decisao explicita |
