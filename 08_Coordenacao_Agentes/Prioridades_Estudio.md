...
- Foco P2 de implementacao (Track 08 `INTEGRATED_FOUNDATION_HARDENED`): `Projetos/draxos-mobile/`
...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Track 08 `INTEGRATED_FOUNDATION_HARDENED` | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Planejar proxima track sobre a fundacao endurecida para features/assets/servicos maiores | iOS sem pedido explicito; mobile browser fora do escopo primario; secrets e service role nunca entram no cliente/export; migration conta/save fora do pacote atual; usar matriz Track 08 como baseline antes de novos pacotes |
