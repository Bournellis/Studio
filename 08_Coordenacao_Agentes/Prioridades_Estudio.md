...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 downloads/manifest T03-P17A republicados | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Publicar pacote Cloudflare aprovado ou configurar token CLI; depois signoff manual Fabio + tester antes de T03-P18 | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
