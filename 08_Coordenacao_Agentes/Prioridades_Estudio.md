...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 ready for implementation | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Executar Track 03: design lock da build interna, Supabase remoto Free, email/senha, dois saves, Base/Social/Competicao/Loja jogaveis e manifest de updates para Android/PC/Web | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
