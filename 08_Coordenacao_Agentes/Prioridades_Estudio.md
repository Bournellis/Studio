...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 design lock complete | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Executar T03-P02: Supabase remoto Free, email/senha e configuracao segura sem commitar secrets | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
