...
- Foco operacional ativo: `Projetos/JogoDaCopa/` (10A publicada e aprovada; 09S fallback aprovado) + `Projetos/draxos-mobile/` (hardening integrado localmente preservado; Arena Runtime Config Sync Ready v3 publicado Web/APK/PC; aguardando prova humana) + `Projetos/FpsPlayground/` (Track 14G mergeada localmente; movimento atual preservado)
...
| Ativo | FpsPlayground | `Projetos/FpsPlayground/` | `P2_IMPLEMENTACAO` | Codigo, design, validacao, playtest no editor e documentacao local | Track 14G mergeada localmente; proximo passo recomendado: Multi-Arena Balance Baseline V1 |
