...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 site protegido + hub Grimorio | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Executar T03-P18 handoff da Internal Alpha v0 | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
