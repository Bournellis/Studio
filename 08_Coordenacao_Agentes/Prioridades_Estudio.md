...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 local save_type ready | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Executar T03-P03C: reset separado por save no runtime local | iOS sem pedido explicito; mobile browser fora do escopo; remoto/builds adiados ate gameplay local pronto; secrets e service role nunca entram no cliente/export |
