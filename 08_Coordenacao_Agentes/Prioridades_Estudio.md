...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 downloads publicados, Portal/Web aguardam host estatico externo | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Escolher/publicar host estatico para Portal/Web antes do signoff completo | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
