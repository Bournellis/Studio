...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - `VISUAL_DIRECTION_V1_PUBLISHED` | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Revisar Visual Direction v1 publicado em Android/Windows/Web e decidir Battle Presentation v1 ou outro pacote explicito | iOS sem pedido explicito; mobile browser fora do escopo primario; secrets e service role nunca entram no cliente/export; publicacao remota exige `-ConfirmRemoteMutation`; mudancas visuais em Entry/Refugio/Batalha exigem `foundation-responsive-layout-contract.md` + `smoke_responsive_layout.gd`; migration conta/save estrutural fora do pacote atual; direct chat, ajudas, contribuicoes, moderacao, tuning numerico, armas, spells, economia, visual final e apresentacao de batalha bloqueados ate decisao explicita |
