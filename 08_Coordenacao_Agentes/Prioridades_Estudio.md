...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Track 04 `ACTIVE_POST_ALPHA_EVOLUTION` | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Execucao paralela controlada da Track 04: coordenacao, Hub scaffold, surfaces, Progression/Economia e Account/Save Gate | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
