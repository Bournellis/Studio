...
|---|---|---|---|---|---|---|---|
| P0 | Draxos Roguelike Cardgame | `Projetos/draxos-roguelike-cardgame/` | Implementacao | `P0_IMPLEMENTACAO` | Codigo, validacao, playtest, documentacao local | Playtest de usuario da Track 02 completa; AutoRun Gate Pack V1, Scenario Fixtures V1, Gameplay Lab V1, Lab Diff Reporter V1, Card Impact Pack V1, Card Impact Effect Signature V2 e Card Redesign Batch 01 disponiveis para regressao/tuning explicitos; proximo trabalho recomendado e endurecer Card Impact V2 para familias nao-dano antes de redesigns amplos | Pode receber trabalho de implementacao por padrao |
