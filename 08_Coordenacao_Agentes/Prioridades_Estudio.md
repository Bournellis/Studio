...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 auth email green | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | T03-P15 manifest remoto de updates e version gate | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
