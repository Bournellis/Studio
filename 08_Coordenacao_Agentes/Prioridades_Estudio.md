...
|---|---|---|---|---|---|---|---|
| P0 | Draxos Roguelike Cardgame | `Projetos/draxos-roguelike-cardgame/` | Implementacao | `P0_IMPLEMENTACAO` | Codigo, validacao, playtest, documentacao local | Playtest de usuario da Track 02 completa; AutoRun Gate Pack V1, Scenario Fixtures V1, Gameplay Lab V1, Lab Diff Reporter V1, Card Impact Pack V1 e Card Impact Effect Signature V2 disponiveis para regressao/tuning explicitos; proximo trabalho recomendado e primeiro lote real de redesign de cartas de jogador usando Card Impact V2 before -> alteracao -> after -> compare | Pode receber trabalho de implementacao por padrao |
