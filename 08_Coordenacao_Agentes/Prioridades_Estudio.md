...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Alpha Hardening Complete | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Executar playtest alpha PC local com checklist Track 01 | iOS sem pedido explicito; mobile browser fora do escopo |
