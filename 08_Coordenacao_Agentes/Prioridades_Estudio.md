...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 manifest green | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | T03-P16 export Android/PC/Web | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
