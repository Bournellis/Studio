...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Bootstrap | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Iniciar T00-P11 - Base Manager E Economia | iOS sem pedido explicito; mobile browser fora do escopo |
