...
- Foco operacional ativo: `Projetos/JogoDaCopa/` (10A publicada e aprovada; 09S fallback aprovado) + `Projetos/draxos-mobile/` (hardening integrado localmente preservado; Arena Runtime Config Sync Ready v3 publicado Web/APK/PC; aguardando prova humana) + `Projetos/FpsPlayground/` (Track 14F mergeada localmente; movimento atual preservado)
