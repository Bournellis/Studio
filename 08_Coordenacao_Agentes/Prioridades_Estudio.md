...
- Foco P2 de implementacao (Track 13 `TRACK_13_VALIDATION_RELEASE_SAFETY_DELIVERED`, pos-Track 10 publicada em 2026-05-28): `Projetos/draxos-mobile/`
...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Track 13 `TRACK_13_VALIDATION_RELEASE_SAFETY_DELIVERED` | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Executar walkthrough manual Android, Windows e Web pelo gate Track 13 antes de novas features | iOS sem pedido explicito; mobile browser fora do escopo primario; secrets e service role nunca entram no cliente/export; publicacao remota exige `-ConfirmRemoteMutation`; migration conta/save fora do pacote atual; tuning numerico bloqueado ate rodada humana Progression Lab; referencias em `assets/referenciaimagens/` sao moodboard, nao runtime assets |
