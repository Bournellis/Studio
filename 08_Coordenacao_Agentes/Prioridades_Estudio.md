...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 T03-P17A Android UI pass local | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Retestar APK local, republicar se aprovado e fazer signoff manual Fabio + tester antes de T03-P18 | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
