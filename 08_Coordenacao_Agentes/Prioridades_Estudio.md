...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Alpha Hardening Complete + Combat Tuning v02 + Battle/Progression Lab Dev | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Rodar Progression Lab com Supabase local, testar saves 2h-20h manualmente no Godot e abrir rodada before/after de recompensa/poder/bots | iOS sem pedido explicito; mobile browser fora do escopo |
