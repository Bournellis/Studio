...
- Foco P2 de implementacao (Track 08 `ACTIVE_FOUNDATION_HARDENING`): `Projetos/draxos-mobile/`
...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Track 08 `ACTIVE_FOUNDATION_HARDENING` | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Endurecer fundacao pos-Track 07 antes de novas features/assets/servicos maiores | iOS sem pedido explicito; mobile browser fora do escopo primario; secrets e service role nunca entram no cliente/export; migration conta/save fora do pacote atual; sem tuning numerico; sem gameplay novo; backend endpoint novo/schema/economia/ranking/recompensas/simulador/assets finais e publicacao remota fora da Track 08 |
