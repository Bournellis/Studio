...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 shop proof-of-concept playable | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Executar T03-P09: Batalha Visual Polish Pequeno | iOS sem pedido explicito; mobile browser fora do escopo; remoto/builds adiados ate gameplay local pronto; secrets e service role nunca entram no cliente/export |
