...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Bootstrap | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Calibrar economia no simulador da T00-P09 | iOS sem pedido explicito; mobile browser fora do escopo |
