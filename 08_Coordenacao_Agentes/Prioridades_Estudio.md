...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 release prep | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | T03-P13 Supabase remoto apos Fabio criar `.env.internal-alpha.local` e confirmar valores publicos do projeto `armxgipvnbbshzqawklw` | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
