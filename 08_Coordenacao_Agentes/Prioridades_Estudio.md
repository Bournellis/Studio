...
- Foco P2 de implementacao (`OPENWORLD_QOL_REGRESSION_FIX_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-openworld-node2d-qol-hotfix-20260601-ba6f129`, preview `https://95f403c5.draxos-mobile-internal-alpha.pages.dev`, preservando Foundation Hardening V2 (`FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`, release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`) e Hardening Platform V1 como baselines anteriores, Track 21 Arena Loop Unlock/Friction como contexto do Autobattler, Track 20 Season 1 Arena Calibration, Remote Lab Runner, Track 13 release safety e Track 14 agent ops): `Projetos/draxos-mobile/`
