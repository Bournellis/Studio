...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 battle visual polish complete | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Preparar T03-P11: QA/playtest local no Godot | iOS sem pedido explicito; mobile browser fora do escopo; remoto/builds adiados ate gameplay local pronto; secrets e service role nunca entram no cliente/export |
