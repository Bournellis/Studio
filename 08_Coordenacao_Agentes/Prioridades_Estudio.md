...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 T03-P17A aprovada | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Executar T03-P18 handoff da Internal Alpha v0 | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
