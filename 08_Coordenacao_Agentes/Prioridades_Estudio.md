...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Alpha Ready | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Executar playtest alpha do primeiro slice | iOS sem pedido explicito; mobile browser fora do escopo |
