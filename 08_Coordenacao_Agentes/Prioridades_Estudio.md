...
- Foco P2 de implementacao (`MINIGAME_PLATFORM_V1_MODES_PUBLISHED_INTERNAL_ALPHA`, publicado em `internal-alpha/v0-minigame-platform-v1-modes-20260601-c0c1e9c`, preservando Track 21 Arena Loop Unlock/Friction, Track 20 Season 1 Arena Calibration, Remote Lab Runner, Track 13 release safety e Track 14 agent ops): `Projetos/draxos-mobile/`
