...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 remote bootstrap green | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | T03-P14 auth email/senha e alpha gate no Godot/backend remoto | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
