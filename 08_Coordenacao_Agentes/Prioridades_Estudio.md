...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Character Systems Rework + Battle/Progression Lab Dev | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Rodar Progression Lab com Supabase local, testar saves 2h-20h manualmente no Godot e abrir rodada before/after de tuning pos-rework: anti-stall, dominancia, poder, recompensa e bots | iOS sem pedido explicito; mobile browser fora do escopo |
