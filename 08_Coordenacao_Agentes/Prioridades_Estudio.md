...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Internal Alpha v0 exports local green | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | T03-P17 publicacao unlisted e QA remoto fechado | iOS sem pedido explicito; mobile browser fora do escopo; secrets e service role nunca entram no cliente/export |
