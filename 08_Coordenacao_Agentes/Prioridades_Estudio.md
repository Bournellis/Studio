...
- Foco operacional ativo: `Projetos/JogoDaCopa/` (09P publicada e aprovada; 09N segue fallback historico aprovado) + `Projetos/draxos-mobile/` (hardening integrado localmente preservado; Arena Runtime Config Sync Ready v3 publicado Web/APK/PC; aguardando prova humana) + `Projetos/FpsPlayground/` (Track 12 telemetry readout pronta para smoke; movimento atual preservado)
