...
- Foco P2 de implementacao (Track 09 `INTEGRATED_PORTRAIT_LOOP_READY`): `Projetos/draxos-mobile/`
...
| P2 | DraxosMobile | `Projetos/draxos-mobile/` | Implementacao - Track 09 `INTEGRATED_PORTRAIT_LOOP_READY` | `P2_IMPLEMENTACAO` | Codigo, design, documentacao local, configuracao de infraestrutura | Fazer walkthrough visual/manual do novo loop portrait antes da proxima track de features/assets | iOS sem pedido explicito; mobile browser fora do escopo primario; secrets e service role nunca entram no cliente/export; migration conta/save fora do pacote atual; referencias em `assets/referenciaimagens/` sao moodboard, nao runtime assets |
