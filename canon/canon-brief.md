...
Local long-term product authority lives in `Projetos/draxos-mobile/docs/product-vision.md`. Use that document for DraxosMobile pillars, anti-pillars, monetization limits, platform boundaries, live ops direction and future-not-promised items until specific parts are promoted into shared canon. The current operational package is Bosque Bootstrap Authority v1, published as Internal Alpha at `internal-alpha/v0-bosque-bootstrap-authority-v1-20260609-ba99e70` with official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://0123894f.draxos-mobile-internal-alpha.pages.dev`, APK/manifest `0.0.15-alpha.0` / version code `15`, and minimum supported version code `13`. Fabio reported the initial human playtest OK on 2026-06-09; documentation drift cleanup is complete, and the current open decision is `DMOB-D076`, choosing the next post-Bootstrap product package. Future bugs return to the normal bugfix flow if they appear. Arena PVE remains the first approved product core; Bosque/Openworld is an integrated Internal Alpha slice, not automatic approval for broad expansion.
...
- DraxosMobile current published package is `BOSQUE_BOOTSTRAP_AUTHORITY_V1_PUBLISHED_INTERNAL_ALPHA`: release root `internal-alpha/v0-bosque-bootstrap-authority-v1-20260609-ba99e70`, official Portal URL `https://draxos-mobile-internal-alpha.pages.dev/`, direct Web URL `https://draxos-mobile-internal-alpha.pages.dev/web/index.html`, deployment evidence `https://0123894f.draxos-mobile-internal-alpha.pages.dev`, APK/manifest `0.0.15-alpha.0` / version code `15`, and minimum supported version code `13`.
- DraxosMobile new work should branch from updated `main` after the Bosque Bootstrap Authority v1 publication and follow `D:\Estudio\Projetos\draxos-mobile\docs\multi-agent-workflow.md`; Openworld Main Menu Sync, Bosque v3 UX/Feel, Arena PVE First Real Run, Arena/Bosque Regression Hotfix, Arena PVE Menu Flow Simplification v1, Bosque Fogueira Potion Crafting v1, Bosque Feel & Spawn Authority v1 and Bosque Node Cooldown ACK v1 are preserved historical baselines, not the current package. Track 13 release safety and Track 14 agent ops remain compatibility baselines.
