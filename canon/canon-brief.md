...
- DraxosMobile current platform baseline is `FOUNDATION_HARDENING_V2_PUBLISHED_INTERNAL_ALPHA`: release root `internal-alpha/v0-foundation-hardening-v2-hotfix2-20260601-58671a4`, preview `https://ca946749.draxos-mobile-internal-alpha.pages.dev`.
