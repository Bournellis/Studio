...
This specific mission is one of the Draxos operations that can succeed, depending on the player.

## The Target Planet

The target is an elemental planet with a large concentration of astral energy.

The Draxos want several things from this world:

- control over a strategic astral-energy location
- enslavement of the elemental beings who live there
- extraction of a huge and powerful crystal located inside a volcano

The planet, elemental societies, elemental types, and final crystal name are still TBD.

## The Draxos Base

The Draxos operate from a base that resembles a spacecraft, but it is not a technological ship.
...
- ether base instead of tavern, guild, or medieval hub
