...
- review_when: o lore compartilhado do Estudio mudar
- supersedes: none
- superseded_by: none

## Purpose

This document defines the shared lore context used by studio projects.
...
Draxos are arcane intergalactic beings of unclear origin. They use astral energy as their core tool, weapon, infrastructure, and expression of power.
...
Imortais is the current player-facing name for the race or people previously called `Heroic` / `Heroico` in placeholder material.

Their detailed lore is pending and must not be invented from old placeholder files. Current RPG Isometrico mechanics may still use technical IDs such as `heroic`, but player-facing canon should refer to Imortais.
